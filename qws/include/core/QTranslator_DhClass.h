...
class DhQTranslator : public DynamicQHandler, public QTranslator
{
private: 
...
public:
  ...
  explicit DhQTranslator() : DynamicQHandler(), QTranslator() {};
  explicit DhQTranslator(QObject* x1) : DynamicQHandler(), QTranslator(x1) {};
  bool isEmpty() const;
  bool DhisEmpty() const;
  bool DvhisEmpty() const;
  QString translate(const char* x1, const char* x2, const char* x3, int x4) const;
  QString Dhtranslate(const char* x1, const char* x2, const char* x3, int x4) const;
  QString Dvhtranslate(const char* x1, const char* x2, const char* x3, int x4) const;
  ~DhQTranslator(){}
