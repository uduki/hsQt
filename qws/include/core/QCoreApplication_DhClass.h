/////////////////////////////////////////////////////////////////////////////
//      
//      File      : QCoreApplication_DhClass.h
...
class DhQCoreApplication : public DynamicQHandler, public QCoreApplication
{
private: 
...
public:
  ...
  explicit DhQCoreApplication(int& x1, char** x2) : DynamicQHandler(), QCoreApplication(x1, x2) {};
