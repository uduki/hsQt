/////////////////////////////////////////////////////////////////////////////
//      
//      File      : QAbstractListModel_DhClass.h
...
class DhQAbstractListModel : public DynamicQHandler, public QAbstractListModel
{
private: 
...
public:
  ...
  explicit DhQAbstractListModel() : DynamicQHandler(), QAbstractListModel() {};
  explicit DhQAbstractListModel(QObject* x1) : DynamicQHandler(), QAbstractListModel(x1) {};
  ...
  QModelIndex index(int x1) const;
  QModelIndex Dhindex(int x1) const;
  QModelIndex Dvhindex(int x1) const;
