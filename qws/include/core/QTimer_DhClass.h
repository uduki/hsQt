...
class DhQTimer : public DynamicQHandler, public QTimer
{
private: 
...
public:
  ...
  explicit DhQTimer() : DynamicQHandler(), QTimer() {};
  explicit DhQTimer(QObject* x1) : DynamicQHandler(), QTimer(x1) {};
