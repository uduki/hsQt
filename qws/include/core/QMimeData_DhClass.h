...
class DhQMimeData : public DynamicQHandler, public QMimeData
{
private: 
...
public:
  ...
  explicit DhQMimeData() : DynamicQHandler(), QMimeData() {};
  bool hasFormat(const QString& x1) const;
  bool DhhasFormat(const QString& x1) const;
  bool DvhhasFormat(const QString& x1) const;
  QVariant retrieveData(const QString& x1, QVariant::Type x2) const;
  QVariant DhretrieveData(const QString& x1, long x2) const;
  QVariant DvhretrieveData(const QString& x1, long x2) const;
  ~DhQMimeData(){}
