...
class DhQFile : public DynamicQHandler, public QFile
{
private: 
...
public:
  ...
  explicit DhQFile() : DynamicQHandler(), QFile() {};
  explicit DhQFile(const QString& x1) : DynamicQHandler(), QFile(x1) {};
  explicit DhQFile(QObject* x1) : DynamicQHandler(), QFile(x1) {};
  explicit DhQFile(const QString& x1, QObject* x2) : DynamicQHandler(), QFile(x1, x2) {};
  bool atEnd() const;
  bool DhatEnd() const;
  bool DvhatEnd() const;
  void close();
  ...
  QAbstractFileEngine* DhfileEngine() const;
  QAbstractFileEngine* DvhfileEngine() const;
