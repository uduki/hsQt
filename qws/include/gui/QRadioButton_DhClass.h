...
class DhQRadioButton : public DynamicQHandler, public QRadioButton
{
private: 
...
public:
  ...
  explicit DhQRadioButton() : DynamicQHandler(), QRadioButton() {};
  explicit DhQRadioButton(QWidget* x1) : DynamicQHandler(), QRadioButton(x1) {};
  explicit DhQRadioButton(const QString& x1) : DynamicQHandler(), QRadioButton(x1) {};
  explicit DhQRadioButton(const QString& x1, QWidget* x2) : DynamicQHandler(), QRadioButton(x1, x2) {};
