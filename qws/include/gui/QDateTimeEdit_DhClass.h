...
class DhQDateTimeEdit : public DynamicQHandler, public QDateTimeEdit
{
private: 
...
public:
  ...
  explicit DhQDateTimeEdit() : DynamicQHandler(), QDateTimeEdit() {};
  explicit DhQDateTimeEdit(const QTime& x1) : DynamicQHandler(), QDateTimeEdit(x1) {};
  explicit DhQDateTimeEdit(const QDateTime& x1) : DynamicQHandler(), QDateTimeEdit(x1) {};
  explicit DhQDateTimeEdit(const QDate& x1) : DynamicQHandler(), QDateTimeEdit(x1) {};
  explicit DhQDateTimeEdit(QWidget* x1) : DynamicQHandler(), QDateTimeEdit(x1) {};
  explicit DhQDateTimeEdit(const QDate& x1, QWidget* x2) : DynamicQHandler(), QDateTimeEdit(x1, x2) {};
  explicit DhQDateTimeEdit(const QDateTime& x1, QWidget* x2) : DynamicQHandler(), QDateTimeEdit(x1, x2) {};
  explicit DhQDateTimeEdit(const QTime& x1, QWidget* x2) : DynamicQHandler(), QDateTimeEdit(x1, x2) {};
  void clear();
  void Dhclear();
  void Dvhclear();
  QDateTime dateTimeFromText(const QString& x1) const;
  QDateTime DhdateTimeFromText(const QString& x1) const;
  QDateTime DvhdateTimeFromText(const QString& x1) const;
  ...
  void initStyleOption(QStyleOptionSpinBox* x1) const;
  void DhinitStyleOption(QStyleOptionSpinBox* x1) const;
  void DvhinitStyleOption(QStyleOptionSpinBox* x1) const;
  ...
  void stepBy(int x1);
  void DhstepBy(int x1);
  void DvhstepBy(int x1);
  QAbstractSpinBox::StepEnabled stepEnabled() const;
  QAbstractSpinBox::StepEnabled DhstepEnabled() const;
  QAbstractSpinBox::StepEnabled DvhstepEnabled() const;
  ...
  QLineEdit* DhlineEdit() const;
  QLineEdit* DvhlineEdit() const;
  ...
  void setLineEdit(QLineEdit* x1);
  void DhsetLineEdit(QLineEdit* x1);
  void DvhsetLineEdit(QLineEdit* x1);
