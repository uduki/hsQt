...
class DhQDesktopWidget : public DynamicQHandler, public QDesktopWidget
{
private: 
...
public:
  ...
  explicit DhQDesktopWidget() : DynamicQHandler(), QDesktopWidget() {};
  void resizeEvent(QResizeEvent* x1);
  void DhresizeEvent(QResizeEvent* x1);
  void DvhresizeEvent(QResizeEvent* x1);
  void resized(int x1);
  void Dhresized(int x1);
  void Dvhresized(int x1);
  void workAreaResized(int x1);
  void DhworkAreaResized(int x1);
  void DvhworkAreaResized(int x1);
  ~DhQDesktopWidget(){}
