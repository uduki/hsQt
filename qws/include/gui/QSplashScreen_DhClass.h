...
class DhQSplashScreen : public DynamicQHandler, public QSplashScreen
{
private: 
...
public:
  ...
  explicit DhQSplashScreen() : DynamicQHandler(), QSplashScreen() {};
  explicit DhQSplashScreen(QWidget* x1) : DynamicQHandler(), QSplashScreen(x1) {};
  explicit DhQSplashScreen(const QPixmap& x1) : DynamicQHandler(), QSplashScreen(x1) {};
  explicit DhQSplashScreen(QWidget* x1, const QPixmap& x2) : DynamicQHandler(), QSplashScreen(x1, x2) {};
  explicit DhQSplashScreen(const QPixmap& x1, Qt::WindowFlags x2) : DynamicQHandler(), QSplashScreen(x1, x2) {};
  explicit DhQSplashScreen(QWidget* x1, const QPixmap& x2, Qt::WindowFlags x3) : DynamicQHandler(), QSplashScreen(x1, x2, x3) {};
  void drawContents(QPainter* x1);
  void DhdrawContents(QPainter* x1);
  void DvhdrawContents(QPainter* x1);
