/////////////////////////////////////////////////////////////////////////////
//      
//      File      : QDoubleValidator_DhClass.h
...
class DhQDoubleValidator : public DynamicQHandler, public QDoubleValidator
{
private: 
...
public:
  ...
  explicit DhQDoubleValidator(QObject* x1) : DynamicQHandler(), QDoubleValidator(x1) {};
  explicit DhQDoubleValidator(double x1, double x2, int x3, QObject* x4) : DynamicQHandler(), QDoubleValidator(x1, x2, x3, x4) {};
  void setRange(double x1, double x2, int x3);
  void DhsetRange(double x1, double x2, int x3);
  void DvhsetRange(double x1, double x2, int x3);
  ~DhQDoubleValidator(){}
