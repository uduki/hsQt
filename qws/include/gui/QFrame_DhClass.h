...
class DhQFrame : public DynamicQHandler, public QFrame
{
private: 
...
public:
  ...
  explicit DhQFrame() : DynamicQHandler(), QFrame() {};
  explicit DhQFrame(QWidget* x1) : DynamicQHandler(), QFrame(x1) {};
  explicit DhQFrame(QWidget* x1, Qt::WindowFlags x2) : DynamicQHandler(), QFrame(x1, x2) {};
