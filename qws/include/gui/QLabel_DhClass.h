...
class DhQLabel : public DynamicQHandler, public QLabel
{
private: 
...
public:
  ...
  explicit DhQLabel() : DynamicQHandler(), QLabel() {};
  explicit DhQLabel(QWidget* x1) : DynamicQHandler(), QLabel(x1) {};
  explicit DhQLabel(const QString& x1) : DynamicQHandler(), QLabel(x1) {};
  explicit DhQLabel(QWidget* x1, Qt::WindowFlags x2) : DynamicQHandler(), QLabel(x1, x2) {};
  explicit DhQLabel(const QString& x1, QWidget* x2) : DynamicQHandler(), QLabel(x1, x2) {};
  explicit DhQLabel(const QString& x1, QWidget* x2, Qt::WindowFlags x3) : DynamicQHandler(), QLabel(x1, x2, x3) {};
