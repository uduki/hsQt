...
class DhQGraphicsItem : public DynamicQHandler, public QGraphicsItem
{
private: 
...
public:
  ...
  explicit DhQGraphicsItem() : DynamicQHandler(), QGraphicsItem() {};
  explicit DhQGraphicsItem(QGraphicsItem* x1) : DynamicQHandler(), QGraphicsItem(x1) {};
  explicit DhQGraphicsItem(QGraphicsTextItem* x1) : DynamicQHandler(), QGraphicsItem(x1) {};
  explicit DhQGraphicsItem(QGraphicsItem* x1, QGraphicsScene* x2) : DynamicQHandler(), QGraphicsItem(x1, x2) {};
  explicit DhQGraphicsItem(QGraphicsTextItem* x1, QGraphicsScene* x2) : DynamicQHandler(), QGraphicsItem(x1, x2) {};
  void addToIndex();
  void DhaddToIndex();
  void DvhaddToIndex();
  void advance(int x1);
