...
class DhQProgressBar : public DynamicQHandler, public QProgressBar
{
private: 
...
public:
  ...
  explicit DhQProgressBar() : DynamicQHandler(), QProgressBar() {};
  explicit DhQProgressBar(QWidget* x1) : DynamicQHandler(), QProgressBar(x1) {};
  bool event(QEvent* x1);
  bool Dhevent(QEvent* x1);
  bool Dvhevent(QEvent* x1);
  void initStyleOption(QStyleOptionProgressBar* x1) const;
  void DhinitStyleOption(QStyleOptionProgressBar* x1) const;
  void DvhinitStyleOption(QStyleOptionProgressBar* x1) const;
  ...
  QString text() const;
  QString Dhtext() const;
  QString Dvhtext() const;
  ~DhQProgressBar(){}
