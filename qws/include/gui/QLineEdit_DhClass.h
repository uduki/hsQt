...
class DhQLineEdit : public DynamicQHandler, public QLineEdit
{
private: 
...
public:
  ...
  explicit DhQLineEdit() : DynamicQHandler(), QLineEdit() {};
  explicit DhQLineEdit(const QString& x1) : DynamicQHandler(), QLineEdit(x1) {};
  explicit DhQLineEdit(QWidget* x1) : DynamicQHandler(), QLineEdit(x1) {};
  explicit DhQLineEdit(const QString& x1, QWidget* x2) : DynamicQHandler(), QLineEdit(x1, x2) {};
  ...
  void initStyleOption(QStyleOptionFrame* x1) const;
  void DhinitStyleOption(QStyleOptionFrame* x1) const;
  void DvhinitStyleOption(QStyleOptionFrame* x1) const;
