/////////////////////////////////////////////////////////////////////////////
//      
//      File      : QGraphicsPixmapItem_DhClass.h
...
class DhQGraphicsPixmapItem : public DynamicQHandler, public QGraphicsPixmapItem
{
private: 
...
public:
  ...
  explicit DhQGraphicsPixmapItem() : DynamicQHandler(), QGraphicsPixmapItem() {};
  explicit DhQGraphicsPixmapItem(QGraphicsItem* x1) : DynamicQHandler(), QGraphicsPixmapItem(x1) {};
  explicit DhQGraphicsPixmapItem(QGraphicsTextItem* x1) : DynamicQHandler(), QGraphicsPixmapItem(x1) {};
  explicit DhQGraphicsPixmapItem(const QPixmap& x1) : DynamicQHandler(), QGraphicsPixmapItem(x1) {};
  explicit DhQGraphicsPixmapItem(const QPixmap& x1, QGraphicsItem* x2) : DynamicQHandler(), QGraphicsPixmapItem(x1, x2) {};
  explicit DhQGraphicsPixmapItem(const QPixmap& x1, QGraphicsTextItem* x2) : DynamicQHandler(), QGraphicsPixmapItem(x1, x2) {};
  explicit DhQGraphicsPixmapItem(QGraphicsItem* x1, QGraphicsScene* x2) : DynamicQHandler(), QGraphicsPixmapItem(x1, x2) {};
  explicit DhQGraphicsPixmapItem(QGraphicsTextItem* x1, QGraphicsScene* x2) : DynamicQHandler(), QGraphicsPixmapItem(x1, x2) {};
  explicit DhQGraphicsPixmapItem(const QPixmap& x1, QGraphicsItem* x2, QGraphicsScene* x3) : DynamicQHandler(), QGraphicsPixmapItem(x1, x2, x3) {};
  explicit DhQGraphicsPixmapItem(const QPixmap& x1, QGraphicsTextItem* x2, QGraphicsScene* x3) : DynamicQHandler(), QGraphicsPixmapItem(x1, x2, x3) {};
