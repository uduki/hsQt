...
class DhQDoubleSpinBox : public DynamicQHandler, public QDoubleSpinBox
{
private: 
...
public:
  ...
  explicit DhQDoubleSpinBox() : DynamicQHandler(), QDoubleSpinBox() {};
  explicit DhQDoubleSpinBox(QWidget* x1) : DynamicQHandler(), QDoubleSpinBox(x1) {};
  QString textFromValue(double x1) const;
  QString DhtextFromValue(double x1) const;
  QString DvhtextFromValue(double x1) const;
  double valueFromText(const QString& x1) const;
  double DhvalueFromText(const QString& x1) const;
  double DvhvalueFromText(const QString& x1) const;
  ~DhQDoubleSpinBox(){}
