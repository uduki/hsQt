...
class DhQDial : public DynamicQHandler, public QDial
{
private: 
...
public:
  ...
  explicit DhQDial() : DynamicQHandler(), QDial() {};
  explicit DhQDial(QWidget* x1) : DynamicQHandler(), QDial(x1) {};
  ...
  void setNotchesVisible(bool x1);
  void DhsetNotchesVisible(bool x1);
  void DvhsetNotchesVisible(bool x1);
  void setWrapping(bool x1);
  void DhsetWrapping(bool x1);
  void DvhsetWrapping(bool x1);
