/////////////////////////////////////////////////////////////////////////////
//      
//      File      : QStandardItemModel_DhClass.h
...
class DhQStandardItemModel : public DynamicQHandler, public QStandardItemModel
{
private: 
...
public:
  ...
  explicit DhQStandardItemModel() : DynamicQHandler(), QStandardItemModel() {};
  explicit DhQStandardItemModel(QObject* x1) : DynamicQHandler(), QStandardItemModel(x1) {};
  explicit DhQStandardItemModel(int x1, int x2) : DynamicQHandler(), QStandardItemModel(x1, x2) {};
  explicit DhQStandardItemModel(int x1, int x2, QObject* x3) : DynamicQHandler(), QStandardItemModel(x1, x2, x3) {};
