...
class DhQTextEdit : public DynamicQHandler, public QTextEdit
{
private: 
...
public:
  ...
  explicit DhQTextEdit() : DynamicQHandler(), QTextEdit() {};
  explicit DhQTextEdit(const QString& x1) : DynamicQHandler(), QTextEdit(x1) {};
  explicit DhQTextEdit(QWidget* x1) : DynamicQHandler(), QTextEdit(x1) {};
  explicit DhQTextEdit(const QString& x1, QWidget* x2) : DynamicQHandler(), QTextEdit(x1, x2) {};
  bool canInsertFromMimeData(const QMimeData* x1) const;
  bool DhcanInsertFromMimeData(const QMimeData* x1) const;
  bool DvhcanInsertFromMimeData(const QMimeData* x1) const;
  ...
  QMimeData* DhcreateMimeDataFromSelection() const;
  QMimeData* DvhcreateMimeDataFromSelection() const;
  ...
  void insertFromMimeData(const QMimeData* x1);
  void DhinsertFromMimeData(const QMimeData* x1);
  void DvhinsertFromMimeData(const QMimeData* x1);
  ...
  QVariant loadResource(int x1, const QUrl& x2);
  QVariant DhloadResource(int x1, const QUrl& x2);
  QVariant DvhloadResource(int x1, const QUrl& x2);
