...
class DhQErrorMessage : public DynamicQHandler, public QErrorMessage
{
private: 
...
public:
  ...
  explicit DhQErrorMessage() : DynamicQHandler(), QErrorMessage() {};
  explicit DhQErrorMessage(QWidget* x1) : DynamicQHandler(), QErrorMessage(x1) {};
