...
class DhQTreeView : public DynamicQHandler, public QTreeView
{
private: 
...
public:
  ...
  explicit DhQTreeView() : DynamicQHandler(), QTreeView() {};
  explicit DhQTreeView(QWidget* x1) : DynamicQHandler(), QTreeView(x1) {};
