...
class DhQTreeWidget : public DynamicQHandler, public QTreeWidget
{
private: 
...
public:
  ...
  explicit DhQTreeWidget() : DynamicQHandler(), QTreeWidget() {};
  explicit DhQTreeWidget(QWidget* x1) : DynamicQHandler(), QTreeWidget(x1) {};
  void dropEvent(QDropEvent* x1);
  void DhdropEvent(QDropEvent* x1);
  void DvhdropEvent(QDropEvent* x1);
  bool dropMimeData(QTreeWidgetItem* x1, int x2, const QMimeData* x3, Qt::DropAction x4);
  bool DhdropMimeData(QTreeWidgetItem* x1, int x2, const QMimeData* x3, long x4);
  bool DvhdropMimeData(QTreeWidgetItem* x1, int x2, const QMimeData* x3, long x4);
  bool event(QEvent* x1);
  bool Dhevent(QEvent* x1);
  bool Dvhevent(QEvent* x1);
  QModelIndex indexFromItem(QTreeWidgetItem* x1) const;
  QModelIndex DhindexFromItem(QTreeWidgetItem* x1) const;
  QModelIndex DvhindexFromItem(QTreeWidgetItem* x1) const;
  QModelIndex indexFromItem(QTreeWidgetItem* x1, int x2) const;
  QModelIndex DhindexFromItem(QTreeWidgetItem* x1, int x2) const;
  QModelIndex DvhindexFromItem(QTreeWidgetItem* x1, int x2) const;
  QTreeWidgetItem* itemFromIndex(const QModelIndex& x1) const;
  QTreeWidgetItem* DhitemFromIndex(const QModelIndex& x1) const;
  QTreeWidgetItem* DvhitemFromIndex(const QModelIndex& x1) const;
  ...
  void drawBranches(QPainter* x1, const QRect& x2, const QModelIndex& x3) const;
  void DhdrawBranches(QPainter* x1, const QRect& x2, const QModelIndex& x3) const;
  void DvhdrawBranches(QPainter* x1, const QRect& x2, const QModelIndex& x3) const;
  void drawRow(QPainter* x1, const QStyleOptionViewItem& x2, const QModelIndex& x3) const;
  void DhdrawRow(QPainter* x1, const QStyleOptionViewItem& x2, const QModelIndex& x3) const;
  void DvhdrawRow(QPainter* x1, const QStyleOptionViewItem& x2, const QModelIndex& x3) const;
  void drawTree(QPainter* x1, const QRegion& x2) const;
  void DhdrawTree(QPainter* x1, const QRegion& x2) const;
  void DvhdrawTree(QPainter* x1, const QRegion& x2) const;
  ...
  int indexRowSizeHint(const QModelIndex& x1) const;
  int DhindexRowSizeHint(const QModelIndex& x1) const;
  int DvhindexRowSizeHint(const QModelIndex& x1) const;
  ...
  void Dhreset();
  void Dvhreset();
  int rowHeight(const QModelIndex& x1) const;
  int DhrowHeight(const QModelIndex& x1) const;
  int DvhrowHeight(const QModelIndex& x1) const;
  ...
  void rowsRemoved(const QModelIndex& x1, int x2, int x3);
  void DhrowsRemoved(const QModelIndex& x1, int x2, int x3);
  void DvhrowsRemoved(const QModelIndex& x1, int x2, int x3);
  void scrollContentsBy(int x1, int x2);
  void DhscrollContentsBy(int x1, int x2);
  void DvhscrollContentsBy(int x1, int x2);
  void scrollTo(const QModelIndex& x1);
  void DhscrollTo(const QModelIndex& x1);
  void DvhscrollTo(const QModelIndex& x1);
