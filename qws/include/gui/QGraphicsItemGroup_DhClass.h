/////////////////////////////////////////////////////////////////////////////
//      
//      File      : QGraphicsItemGroup_DhClass.h
...
class DhQGraphicsItemGroup : public DynamicQHandler, public QGraphicsItemGroup
{
private: 
...
public:
  ...
  explicit DhQGraphicsItemGroup() : DynamicQHandler(), QGraphicsItemGroup() {};
  explicit DhQGraphicsItemGroup(QGraphicsItem* x1) : DynamicQHandler(), QGraphicsItemGroup(x1) {};
  explicit DhQGraphicsItemGroup(QGraphicsTextItem* x1) : DynamicQHandler(), QGraphicsItemGroup(x1) {};
  explicit DhQGraphicsItemGroup(QGraphicsItem* x1, QGraphicsScene* x2) : DynamicQHandler(), QGraphicsItemGroup(x1, x2) {};
  explicit DhQGraphicsItemGroup(QGraphicsTextItem* x1, QGraphicsScene* x2) : DynamicQHandler(), QGraphicsItemGroup(x1, x2) {};
