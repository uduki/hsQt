...
class DhQGraphicsView : public DynamicQHandler, public QGraphicsView
{
private: 
...
public:
  ...
  explicit DhQGraphicsView() : DynamicQHandler(), QGraphicsView() {};
  explicit DhQGraphicsView(QWidget* x1) : DynamicQHandler(), QGraphicsView(x1) {};
  explicit DhQGraphicsView(QGraphicsScene* x1) : DynamicQHandler(), QGraphicsView(x1) {};
  explicit DhQGraphicsView(QGraphicsScene* x1, QWidget* x2) : DynamicQHandler(), QGraphicsView(x1, x2) {};
  ...
  void drawItems(QPainter* x1, int x2, QGraphicsItem** x3, const QStyleOptionGraphicsItem* x4);
  void DhdrawItems(QPainter* x1, int x2, QGraphicsItem** x3, const QStyleOptionGraphicsItem* x4);
  void DvhdrawItems(QPainter* x1, int x2, QGraphicsItem** x3, const QStyleOptionGraphicsItem* x4);
