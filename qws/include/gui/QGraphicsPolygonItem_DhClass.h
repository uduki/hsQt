/////////////////////////////////////////////////////////////////////////////
//      
//      File      : QGraphicsPolygonItem_DhClass.h
...
class DhQGraphicsPolygonItem : public DynamicQHandler, public QGraphicsPolygonItem
{
private: 
...
public:
  ...
  explicit DhQGraphicsPolygonItem() : DynamicQHandler(), QGraphicsPolygonItem() {};
  explicit DhQGraphicsPolygonItem(const QPolygonF& x1) : DynamicQHandler(), QGraphicsPolygonItem(x1) {};
  explicit DhQGraphicsPolygonItem(QGraphicsItem* x1) : DynamicQHandler(), QGraphicsPolygonItem(x1) {};
  explicit DhQGraphicsPolygonItem(QGraphicsTextItem* x1) : DynamicQHandler(), QGraphicsPolygonItem(x1) {};
  explicit DhQGraphicsPolygonItem(QGraphicsItem* x1, QGraphicsScene* x2) : DynamicQHandler(), QGraphicsPolygonItem(x1, x2) {};
  explicit DhQGraphicsPolygonItem(QGraphicsTextItem* x1, QGraphicsScene* x2) : DynamicQHandler(), QGraphicsPolygonItem(x1, x2) {};
  explicit DhQGraphicsPolygonItem(const QPolygonF& x1, QGraphicsItem* x2) : DynamicQHandler(), QGraphicsPolygonItem(x1, x2) {};
  explicit DhQGraphicsPolygonItem(const QPolygonF& x1, QGraphicsTextItem* x2) : DynamicQHandler(), QGraphicsPolygonItem(x1, x2) {};
  explicit DhQGraphicsPolygonItem(const QPolygonF& x1, QGraphicsItem* x2, QGraphicsScene* x3) : DynamicQHandler(), QGraphicsPolygonItem(x1, x2, x3) {};
  explicit DhQGraphicsPolygonItem(const QPolygonF& x1, QGraphicsTextItem* x2, QGraphicsScene* x3) : DynamicQHandler(), QGraphicsPolygonItem(x1, x2, x3) {};
