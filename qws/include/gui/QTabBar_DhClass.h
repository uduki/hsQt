...
class DhQTabBar : public DynamicQHandler, public QTabBar
{
private: 
...
public:
  ...
  explicit DhQTabBar() : DynamicQHandler(), QTabBar() {};
  explicit DhQTabBar(QWidget* x1) : DynamicQHandler(), QTabBar(x1) {};
  ...
  void initStyleOption(QStyleOptionTab* x1, int x2) const;
  void DhinitStyleOption(QStyleOptionTab* x1, int x2) const;
  void DvhinitStyleOption(QStyleOptionTab* x1, int x2) const;
  ...
  void DhtabLayoutChange();
  void DvhtabLayoutChange();
  void tabRemoved(int x1);
  void DhtabRemoved(int x1);
  void DvhtabRemoved(int x1);
  QSize tabSizeHint(int x1) const;
  QSize DhtabSizeHint(int x1) const;
  QSize DvhtabSizeHint(int x1) const;
  ~DhQTabBar(){}
