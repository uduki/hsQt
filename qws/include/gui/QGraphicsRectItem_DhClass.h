/////////////////////////////////////////////////////////////////////////////
//      
//      File      : QGraphicsRectItem_DhClass.h
...
class DhQGraphicsRectItem : public DynamicQHandler, public QGraphicsRectItem
{
private: 
...
public:
  ...
  explicit DhQGraphicsRectItem() : DynamicQHandler(), QGraphicsRectItem() {};
  explicit DhQGraphicsRectItem(const QRectF& x1) : DynamicQHandler(), QGraphicsRectItem(x1) {};
  explicit DhQGraphicsRectItem(QGraphicsItem* x1) : DynamicQHandler(), QGraphicsRectItem(x1) {};
  explicit DhQGraphicsRectItem(QGraphicsTextItem* x1) : DynamicQHandler(), QGraphicsRectItem(x1) {};
  explicit DhQGraphicsRectItem(const QRectF& x1, QGraphicsItem* x2) : DynamicQHandler(), QGraphicsRectItem(x1, x2) {};
  explicit DhQGraphicsRectItem(const QRectF& x1, QGraphicsTextItem* x2) : DynamicQHandler(), QGraphicsRectItem(x1, x2) {};
  explicit DhQGraphicsRectItem(QGraphicsItem* x1, QGraphicsScene* x2) : DynamicQHandler(), QGraphicsRectItem(x1, x2) {};
  explicit DhQGraphicsRectItem(QGraphicsTextItem* x1, QGraphicsScene* x2) : DynamicQHandler(), QGraphicsRectItem(x1, x2) {};
  explicit DhQGraphicsRectItem(const QRectF& x1, QGraphicsItem* x2, QGraphicsScene* x3) : DynamicQHandler(), QGraphicsRectItem(x1, x2, x3) {};
  explicit DhQGraphicsRectItem(const QRectF& x1, QGraphicsTextItem* x2, QGraphicsScene* x3) : DynamicQHandler(), QGraphicsRectItem(x1, x2, x3) {};
  explicit DhQGraphicsRectItem(qreal x1, qreal x2, qreal x3, qreal x4) : DynamicQHandler(), QGraphicsRectItem(x1, x2, x3, x4) {};
  explicit DhQGraphicsRectItem(qreal x1, qreal x2, qreal x3, qreal x4, QGraphicsItem* x5) : DynamicQHandler(), QGraphicsRectItem(x1, x2, x3, x4, x5) {};
  explicit DhQGraphicsRectItem(qreal x1, qreal x2, qreal x3, qreal x4, QGraphicsTextItem* x5) : DynamicQHandler(), QGraphicsRectItem(x1, x2, x3, x4, x5) {};
  explicit DhQGraphicsRectItem(qreal x1, qreal x2, qreal x3, qreal x4, QGraphicsItem* x5, QGraphicsScene* x6) : DynamicQHandler(), QGraphicsRectItem(x1, x2, x3, x4, x5, x6) {};
  explicit DhQGraphicsRectItem(qreal x1, qreal x2, qreal x3, qreal x4, QGraphicsTextItem* x5, QGraphicsScene* x6) : DynamicQHandler(), QGraphicsRectItem(x1, x2, x3, x4, x5, x6) {};
