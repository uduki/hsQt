...
class DhQTextTable : public DynamicQHandler, public QTextTable
{
private: 
...
public:
  ...
  explicit DhQTextTable(QTextDocument* x1) : DynamicQHandler(), QTextTable(x1) {};
  ~DhQTextTable(){}
