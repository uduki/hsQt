/////////////////////////////////////////////////////////////////////////////
//      
//      File      : QDialogButtonBox_DhClass.h
...
class DhQDialogButtonBox : public DynamicQHandler, public QDialogButtonBox
{
private: 
...
public:
  ...
  explicit DhQDialogButtonBox() : DynamicQHandler(), QDialogButtonBox() {};
  explicit DhQDialogButtonBox(QDialogButtonBox::StandardButtons x1) : DynamicQHandler(), QDialogButtonBox(x1) {};
  explicit DhQDialogButtonBox(Qt::Orientation x1) : DynamicQHandler(), QDialogButtonBox(x1) {};
  explicit DhQDialogButtonBox(QWidget* x1) : DynamicQHandler(), QDialogButtonBox(x1) {};
  explicit DhQDialogButtonBox(Qt::Orientation x1, QWidget* x2) : DynamicQHandler(), QDialogButtonBox(x1, x2) {};
  explicit DhQDialogButtonBox(QDialogButtonBox::StandardButtons x1, Qt::Orientation x2) : DynamicQHandler(), QDialogButtonBox(x1, x2) {};
  explicit DhQDialogButtonBox(QDialogButtonBox::StandardButtons x1, Qt::Orientation x2, QWidget* x3) : DynamicQHandler(), QDialogButtonBox(x1, x2, x3) {};
