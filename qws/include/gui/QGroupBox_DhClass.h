...
class DhQGroupBox : public DynamicQHandler, public QGroupBox
{
private: 
...
public:
  ...
  explicit DhQGroupBox() : DynamicQHandler(), QGroupBox() {};
  explicit DhQGroupBox(QWidget* x1) : DynamicQHandler(), QGroupBox(x1) {};
  explicit DhQGroupBox(const QString& x1) : DynamicQHandler(), QGroupBox(x1) {};
  explicit DhQGroupBox(const QString& x1, QWidget* x2) : DynamicQHandler(), QGroupBox(x1, x2) {};
  ...
  void initStyleOption(QStyleOptionGroupBox* x1) const;
  void DhinitStyleOption(QStyleOptionGroupBox* x1) const;
  void DvhinitStyleOption(QStyleOptionGroupBox* x1) const;
