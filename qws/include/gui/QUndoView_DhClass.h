...
class DhQUndoView : public DynamicQHandler, public QUndoView
{
private: 
...
public:
  ...
  explicit DhQUndoView() : DynamicQHandler(), QUndoView() {};
  explicit DhQUndoView(QWidget* x1) : DynamicQHandler(), QUndoView(x1) {};
  explicit DhQUndoView(QUndoStack* x1) : DynamicQHandler(), QUndoView(x1) {};
  explicit DhQUndoView(QUndoGroup* x1) : DynamicQHandler(), QUndoView(x1) {};
  explicit DhQUndoView(QUndoGroup* x1, QWidget* x2) : DynamicQHandler(), QUndoView(x1, x2) {};
  explicit DhQUndoView(QUndoStack* x1, QWidget* x2) : DynamicQHandler(), QUndoView(x1, x2) {};
  ~DhQUndoView(){}
