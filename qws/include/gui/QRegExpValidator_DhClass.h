/////////////////////////////////////////////////////////////////////////////
//      
//      File      : QRegExpValidator_DhClass.h
...
class DhQRegExpValidator : public DynamicQHandler, public QRegExpValidator
{
private: 
...
public:
  ...
  explicit DhQRegExpValidator(QObject* x1) : DynamicQHandler(), QRegExpValidator(x1) {};
  explicit DhQRegExpValidator(const QRegExp& x1, QObject* x2) : DynamicQHandler(), QRegExpValidator(x1, x2) {};
  ~DhQRegExpValidator(){}
