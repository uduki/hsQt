...
class DhQAction : public DynamicQHandler, public QAction
{
private: 
...
public:
  ...
  explicit DhQAction(QObject* x1) : DynamicQHandler(), QAction(x1) {};
  explicit DhQAction(const QString& x1, QObject* x2) : DynamicQHandler(), QAction(x1, x2) {};
  explicit DhQAction(const QIcon& x1, const QString& x2, QObject* x3) : DynamicQHandler(), QAction(x1, x2, x3) {};
