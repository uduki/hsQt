...
class DhQDockWidget : public DynamicQHandler, public QDockWidget
{
private: 
...
public:
  ...
  explicit DhQDockWidget() : DynamicQHandler(), QDockWidget() {};
  explicit DhQDockWidget(const QString& x1) : DynamicQHandler(), QDockWidget(x1) {};
  explicit DhQDockWidget(QWidget* x1) : DynamicQHandler(), QDockWidget(x1) {};
  explicit DhQDockWidget(QWidget* x1, Qt::WindowFlags x2) : DynamicQHandler(), QDockWidget(x1, x2) {};
  explicit DhQDockWidget(const QString& x1, QWidget* x2) : DynamicQHandler(), QDockWidget(x1, x2) {};
  explicit DhQDockWidget(const QString& x1, QWidget* x2, Qt::WindowFlags x3) : DynamicQHandler(), QDockWidget(x1, x2, x3) {};
  ...
  void initStyleOption(QStyleOptionDockWidget* x1) const;
  void DhinitStyleOption(QStyleOptionDockWidget* x1) const;
  void DvhinitStyleOption(QStyleOptionDockWidget* x1) const;
