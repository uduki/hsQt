...
class DhQScrollBar : public DynamicQHandler, public QScrollBar
{
private: 
...
public:
  ...
  explicit DhQScrollBar() : DynamicQHandler(), QScrollBar() {};
  explicit DhQScrollBar(QWidget* x1) : DynamicQHandler(), QScrollBar(x1) {};
  explicit DhQScrollBar(Qt::Orientation x1) : DynamicQHandler(), QScrollBar(x1) {};
  explicit DhQScrollBar(Qt::Orientation x1, QWidget* x2) : DynamicQHandler(), QScrollBar(x1, x2) {};
  ...
  void initStyleOption(QStyleOptionSlider* x1) const;
  void DhinitStyleOption(QStyleOptionSlider* x1) const;
  void DvhinitStyleOption(QStyleOptionSlider* x1) const;
  ...
  void sliderChange(QAbstractSlider::SliderChange x1);
  void DhsliderChange(long x1);
  void DvhsliderChange(long x1);
  ~DhQScrollBar(){}
  ...
  QAbstractSlider::SliderAction DhrepeatAction() const;
  QAbstractSlider::SliderAction DvhrepeatAction() const;
  void setRepeatAction(QAbstractSlider::SliderAction x1);
  void DhsetRepeatAction(long x1);
  void DvhsetRepeatAction(long x1);
  void setRepeatAction(QAbstractSlider::SliderAction x1, int x2);
  void DhsetRepeatAction(long x1, int x2);
  void DvhsetRepeatAction(long x1, int x2);
  void setRepeatAction(QAbstractSlider::SliderAction x1, int x2, int x3);
  void DhsetRepeatAction(long x1, int x2, int x3);
  void DvhsetRepeatAction(long x1, int x2, int x3);
