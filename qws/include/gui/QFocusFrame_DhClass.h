...
class DhQFocusFrame : public DynamicQHandler, public QFocusFrame
{
private: 
...
public:
  ...
  explicit DhQFocusFrame() : DynamicQHandler(), QFocusFrame() {};
  explicit DhQFocusFrame(QWidget* x1) : DynamicQHandler(), QFocusFrame(x1) {};
  ...
  void initStyleOption(QStyleOption* x1) const;
  void DhinitStyleOption(QStyleOption* x1) const;
  void DvhinitStyleOption(QStyleOption* x1) const;
