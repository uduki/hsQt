/////////////////////////////////////////////////////////////////////////////
//      
//      File      : QItemSelectionModel_DhClass.h
...
class DhQItemSelectionModel : public DynamicQHandler, public QItemSelectionModel
{
private: 
...
public:
  ...
  explicit DhQItemSelectionModel(QAbstractItemModel* x1) : DynamicQHandler(), QItemSelectionModel(x1) {};
  explicit DhQItemSelectionModel(QAbstractItemModel* x1, QObject* x2) : DynamicQHandler(), QItemSelectionModel(x1, x2) {};
  void clear();
  void Dhclear();
  void Dvhclear();
  void emitSelectionChanged(const QItemSelection& x1, const QItemSelection& x2);
  void DhemitSelectionChanged(const QItemSelection& x1, const QItemSelection& x2);
  void DvhemitSelectionChanged(const QItemSelection& x1, const QItemSelection& x2);
  void reset();
  void Dhreset();
  void Dvhreset();
  void select(const QModelIndex& x1, QItemSelectionModel::SelectionFlags x2);
  void Dhselect(const QModelIndex& x1, long x2);
  void Dvhselect(const QModelIndex& x1, long x2);
  ~DhQItemSelectionModel(){}
