...
class DhQToolButton : public DynamicQHandler, public QToolButton
{
private: 
...
public:
  ...
  explicit DhQToolButton() : DynamicQHandler(), QToolButton() {};
  explicit DhQToolButton(QWidget* x1) : DynamicQHandler(), QToolButton(x1) {};
  ...
  void initStyleOption(QStyleOptionToolButton* x1) const;
  void DhinitStyleOption(QStyleOptionToolButton* x1) const;
  void DvhinitStyleOption(QStyleOptionToolButton* x1) const;
