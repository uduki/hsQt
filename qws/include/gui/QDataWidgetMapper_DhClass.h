/////////////////////////////////////////////////////////////////////////////
//      
//      File      : QDataWidgetMapper_DhClass.h
...
class DhQDataWidgetMapper : public DynamicQHandler, public QDataWidgetMapper
{
private: 
...
public:
  ...
  explicit DhQDataWidgetMapper() : DynamicQHandler(), QDataWidgetMapper() {};
  explicit DhQDataWidgetMapper(QObject* x1) : DynamicQHandler(), QDataWidgetMapper(x1) {};
  void setCurrentIndex(int x1);
  void DhsetCurrentIndex(int x1);
  void DvhsetCurrentIndex(int x1);
  ~DhQDataWidgetMapper(){}
