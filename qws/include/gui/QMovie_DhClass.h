...
class DhQMovie : public DynamicQHandler, public QMovie
{
private: 
...
public:
  ...
  explicit DhQMovie() : DynamicQHandler(), QMovie() {};
  explicit DhQMovie(const QString& x1) : DynamicQHandler(), QMovie(x1) {};
  explicit DhQMovie(QObject* x1) : DynamicQHandler(), QMovie(x1) {};
  explicit DhQMovie(QIODevice* x1) : DynamicQHandler(), QMovie(x1) {};
  explicit DhQMovie(QIODevice* x1, const QByteArray& x2) : DynamicQHandler(), QMovie(x1, x2) {};
  explicit DhQMovie(const QString& x1, const QByteArray& x2) : DynamicQHandler(), QMovie(x1, x2) {};
  explicit DhQMovie(const QString& x1, const QByteArray& x2, QObject* x3) : DynamicQHandler(), QMovie(x1, x2, x3) {};
  explicit DhQMovie(QIODevice* x1, const QByteArray& x2, QObject* x3) : DynamicQHandler(), QMovie(x1, x2, x3) {};
  ~DhQMovie(){}
