...
class DhQTabWidget : public DynamicQHandler, public QTabWidget
{
private: 
...
public:
  ...
  explicit DhQTabWidget() : DynamicQHandler(), QTabWidget() {};
  explicit DhQTabWidget(QWidget* x1) : DynamicQHandler(), QTabWidget(x1) {};
  ...
  void initStyleOption(QStyleOptionTabWidgetFrame* x1) const;
  void DhinitStyleOption(QStyleOptionTabWidgetFrame* x1) const;
  void DvhinitStyleOption(QStyleOptionTabWidgetFrame* x1) const;
  ...
  void setTabBar(QTabBar* x1);
  void DhsetTabBar(QTabBar* x1);
  void DvhsetTabBar(QTabBar* x1);
  ...
  QTabBar* DhtabBar() const;
  QTabBar* DvhtabBar() const;
  void tabInserted(int x1);
  void DhtabInserted(int x1);
  void DvhtabInserted(int x1);
  void tabRemoved(int x1);
  void DhtabRemoved(int x1);
  void DvhtabRemoved(int x1);
  ~DhQTabWidget(){}
