...
class DhQMenuBar : public DynamicQHandler, public QMenuBar
{
private: 
...
public:
  ...
  explicit DhQMenuBar() : DynamicQHandler(), QMenuBar() {};
  explicit DhQMenuBar(QWidget* x1) : DynamicQHandler(), QMenuBar(x1) {};
