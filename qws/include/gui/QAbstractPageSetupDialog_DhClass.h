/////////////////////////////////////////////////////////////////////////////
//      
//      File      : QAbstractPageSetupDialog_DhClass.h
...
class DhQAbstractPageSetupDialog : public DynamicQHandler, public QAbstractPageSetupDialog
{
private: 
...
public:
  ...
  explicit DhQAbstractPageSetupDialog(QPrinter* x1) : DynamicQHandler(), QAbstractPageSetupDialog(x1) {};
  explicit DhQAbstractPageSetupDialog(QPrinter* x1, QWidget* x2) : DynamicQHandler(), QAbstractPageSetupDialog(x1, x2) {};
  int exec();
  int Dhexec();
  int Dvhexec();
  ~DhQAbstractPageSetupDialog(){}
  void accept();
  void Dhaccept();
  void Dvhaccept();
