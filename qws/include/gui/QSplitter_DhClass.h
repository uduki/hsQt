...
class DhQSplitter : public DynamicQHandler, public QSplitter
{
private: 
...
public:
  ...
  explicit DhQSplitter() : DynamicQHandler(), QSplitter() {};
  explicit DhQSplitter(QWidget* x1) : DynamicQHandler(), QSplitter(x1) {};
  explicit DhQSplitter(Qt::Orientation x1) : DynamicQHandler(), QSplitter(x1) {};
  explicit DhQSplitter(Qt::Orientation x1, QWidget* x2) : DynamicQHandler(), QSplitter(x1, x2) {};
  ...
  int closestLegalPosition(int x1, int x2);
  int DhclosestLegalPosition(int x1, int x2);
  int DvhclosestLegalPosition(int x1, int x2);
  QSplitterHandle* createHandle();
  QSplitterHandle* DhcreateHandle();
  QSplitterHandle* DvhcreateHandle();
  ...
  void moveSplitter(int x1, int x2);
  void DhmoveSplitter(int x1, int x2);
  void DvhmoveSplitter(int x1, int x2);
  void resizeEvent(QResizeEvent* x1);
  void DhresizeEvent(QResizeEvent* x1);
  void DvhresizeEvent(QResizeEvent* x1);
  void setRubberBand(int x1);
  void DhsetRubberBand(int x1);
  void DvhsetRubberBand(int x1);
