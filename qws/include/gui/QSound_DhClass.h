...
class DhQSound : public DynamicQHandler, public QSound
{
private: 
...
public:
  ...
  explicit DhQSound(const QString& x1) : DynamicQHandler(), QSound(x1) {};
  explicit DhQSound(const QString& x1, QObject* x2) : DynamicQHandler(), QSound(x1, x2) {};
  ~DhQSound(){}
