...
class DhQGridLayout : public DynamicQHandler, public QGridLayout
{
private: 
...
public:
  ...
  explicit DhQGridLayout() : DynamicQHandler(), QGridLayout() {};
  explicit DhQGridLayout(QWidget* x1) : DynamicQHandler(), QGridLayout(x1) {};
  int count() const;
  int Dhcount() const;
  int Dvhcount() const;
