...
class DhQRubberBand : public DynamicQHandler, public QRubberBand
{
private: 
...
public:
  ...
  explicit DhQRubberBand(QRubberBand::Shape x1) : DynamicQHandler(), QRubberBand(x1) {};
  explicit DhQRubberBand(QRubberBand::Shape x1, QWidget* x2) : DynamicQHandler(), QRubberBand(x1, x2) {};
  ...
  void initStyleOption(QStyleOptionRubberBand* x1) const;
  void DhinitStyleOption(QStyleOptionRubberBand* x1) const;
  void DvhinitStyleOption(QStyleOptionRubberBand* x1) const;
