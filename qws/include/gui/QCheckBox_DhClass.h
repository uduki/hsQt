...
class DhQCheckBox : public DynamicQHandler, public QCheckBox
{
private: 
...
public:
  ...
  explicit DhQCheckBox() : DynamicQHandler(), QCheckBox() {};
  explicit DhQCheckBox(QWidget* x1) : DynamicQHandler(), QCheckBox(x1) {};
  explicit DhQCheckBox(const QString& x1) : DynamicQHandler(), QCheckBox(x1) {};
  explicit DhQCheckBox(const QString& x1, QWidget* x2) : DynamicQHandler(), QCheckBox(x1, x2) {};
  void checkStateSet();
