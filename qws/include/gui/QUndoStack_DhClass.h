...
class DhQUndoStack : public DynamicQHandler, public QUndoStack
{
private: 
...
public:
  ...
  explicit DhQUndoStack() : DynamicQHandler(), QUndoStack() {};
  explicit DhQUndoStack(QObject* x1) : DynamicQHandler(), QUndoStack(x1) {};
  ~DhQUndoStack(){}
