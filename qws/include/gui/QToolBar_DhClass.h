...
class DhQToolBar : public DynamicQHandler, public QToolBar
{
private: 
...
public:
  ...
  explicit DhQToolBar() : DynamicQHandler(), QToolBar() {};
  explicit DhQToolBar(QWidget* x1) : DynamicQHandler(), QToolBar(x1) {};
  ...
  void initStyleOption(QStyleOptionToolBar* x1) const;
  void DhinitStyleOption(QStyleOptionToolBar* x1) const;
  void DvhinitStyleOption(QStyleOptionToolBar* x1) const;
