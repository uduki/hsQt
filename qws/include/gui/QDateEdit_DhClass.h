...
class DhQDateEdit : public DynamicQHandler, public QDateEdit
{
private: 
...
public:
  ...
  explicit DhQDateEdit() : DynamicQHandler(), QDateEdit() {};
  explicit DhQDateEdit(QWidget* x1) : DynamicQHandler(), QDateEdit(x1) {};
  explicit DhQDateEdit(const QDate& x1) : DynamicQHandler(), QDateEdit(x1) {};
  explicit DhQDateEdit(const QDate& x1, QWidget* x2) : DynamicQHandler(), QDateEdit(x1, x2) {};
  ~DhQDateEdit(){}
  void clear();
  void Dhclear();
  void Dvhclear();
