...
class DhQTextFrame : public DynamicQHandler, public QTextFrame
{
private: 
...
public:
  ...
  explicit DhQTextFrame(QTextDocument* x1) : DynamicQHandler(), QTextFrame(x1) {};
  ~DhQTextFrame(){}
