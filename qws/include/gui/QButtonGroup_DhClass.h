...
class DhQButtonGroup : public DynamicQHandler, public QButtonGroup
{
private: 
...
public:
  ...
  explicit DhQButtonGroup() : DynamicQHandler(), QButtonGroup() {};
  explicit DhQButtonGroup(QObject* x1) : DynamicQHandler(), QButtonGroup(x1) {};
  ~DhQButtonGroup(){}
