...
class DhQWidget : public DynamicQHandler, public QWidget
{
private: 
...
public:
  ...
  explicit DhQWidget() : DynamicQHandler(), QWidget() {};
  explicit DhQWidget(QWidget* x1) : DynamicQHandler(), QWidget(x1) {};
  explicit DhQWidget(QWidget* x1, Qt::WindowFlags x2) : DynamicQHandler(), QWidget(x1, x2) {};
