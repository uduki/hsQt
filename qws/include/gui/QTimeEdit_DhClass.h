...
class DhQTimeEdit : public DynamicQHandler, public QTimeEdit
{
private: 
...
public:
  ...
  explicit DhQTimeEdit() : DynamicQHandler(), QTimeEdit() {};
  explicit DhQTimeEdit(QWidget* x1) : DynamicQHandler(), QTimeEdit(x1) {};
  explicit DhQTimeEdit(const QTime& x1) : DynamicQHandler(), QTimeEdit(x1) {};
  explicit DhQTimeEdit(const QTime& x1, QWidget* x2) : DynamicQHandler(), QTimeEdit(x1, x2) {};
  ~DhQTimeEdit(){}
  void clear();
  void Dhclear();
  void Dvhclear();
