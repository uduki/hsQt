...
class DhQTextBrowser : public DynamicQHandler, public QTextBrowser
{
private: 
...
public:
  ...
  explicit DhQTextBrowser() : DynamicQHandler(), QTextBrowser() {};
  explicit DhQTextBrowser(QWidget* x1) : DynamicQHandler(), QTextBrowser(x1) {};
  void backward();
  void Dhbackward();
  void Dvhbackward();
  ...
  void Dhreload();
  void Dvhreload();
  void setSource(const QUrl& x1);
  void DhsetSource(const QUrl& x1);
  void DvhsetSource(const QUrl& x1);
  ~DhQTextBrowser(){}
