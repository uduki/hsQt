...
class DhQListWidget : public DynamicQHandler, public QListWidget
{
private: 
...
public:
  ...
  explicit DhQListWidget() : DynamicQHandler(), QListWidget() {};
  explicit DhQListWidget(QWidget* x1) : DynamicQHandler(), QListWidget(x1) {};
  bool dropMimeData(int x1, const QMimeData* x2, Qt::DropAction x3);
  bool DhdropMimeData(int x1, const QMimeData* x2, long x3);
  bool DvhdropMimeData(int x1, const QMimeData* x2, long x3);
  bool event(QEvent* x1);
  bool Dhevent(QEvent* x1);
  bool Dvhevent(QEvent* x1);
  QModelIndex indexFromItem(QListWidgetItem* x1) const;
  QModelIndex DhindexFromItem(QListWidgetItem* x1) const;
  QModelIndex DvhindexFromItem(QListWidgetItem* x1) const;
  QListWidgetItem* itemFromIndex(const QModelIndex& x1) const;
  QListWidgetItem* DhitemFromIndex(const QModelIndex& x1) const;
  QListWidgetItem* DvhitemFromIndex(const QModelIndex& x1) const;
  QList<QListWidgetItem*> items(const QMimeData* x1) const;
  QList<QListWidgetItem*> Dhitems(const QMimeData* x1) const;
  QList<QListWidgetItem*> Dvhitems(const QMimeData* x1) const;
  Qt::DropActions supportedDropActions() const;
  Qt::DropActions DhsupportedDropActions() const;
  Qt::DropActions DvhsupportedDropActions() const;
  ~DhQListWidget(){}
  QSize contentsSize() const;
  QSize DhcontentsSize() const;
  QSize DvhcontentsSize() const;
  ...
  void internalDrag(Qt::DropActions x1);
  void DhinternalDrag(long x1);
  void DvhinternalDrag(long x1);
  void internalDrop(QDropEvent* x1);
  void DhinternalDrop(QDropEvent* x1);
  void DvhinternalDrop(QDropEvent* x1);
  ...
  QRect rectForIndex(const QModelIndex& x1) const;
  QRect DhrectForIndex(const QModelIndex& x1) const;
  QRect DvhrectForIndex(const QModelIndex& x1) const;
  void reset();
  void Dhreset();
  void Dvhreset();
  void resizeContents(int x1, int x2);
  void DhresizeContents(int x1, int x2);
  void DvhresizeContents(int x1, int x2);
  ...
  void setPositionForIndex(const QPoint& x1, const QModelIndex& x2);
  void DhsetPositionForIndex(const QPoint& x1, const QModelIndex& x2);
  void DvhsetPositionForIndex(const QPoint& x1, const QModelIndex& x2);
