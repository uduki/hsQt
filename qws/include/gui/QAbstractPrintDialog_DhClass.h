/////////////////////////////////////////////////////////////////////////////
//      
//      File      : QAbstractPrintDialog_DhClass.h
...
class DhQAbstractPrintDialog : public DynamicQHandler, public QAbstractPrintDialog
{
private: 
...
public:
  ...
  explicit DhQAbstractPrintDialog(QPrinter* x1) : DynamicQHandler(), QAbstractPrintDialog(x1) {};
  explicit DhQAbstractPrintDialog(QPrinter* x1, QWidget* x2) : DynamicQHandler(), QAbstractPrintDialog(x1, x2) {};
  int exec();
  int Dhexec();
  int Dvhexec();
  ~DhQAbstractPrintDialog(){}
  void accept();
  void Dhaccept();
  void Dvhaccept();
