/////////////////////////////////////////////////////////////////////////////
//      
//      File      : QGraphicsItemAnimation_DhClass.h
...
class DhQGraphicsItemAnimation : public DynamicQHandler, public QGraphicsItemAnimation
{
private: 
...
public:
  ...
  explicit DhQGraphicsItemAnimation() : DynamicQHandler(), QGraphicsItemAnimation() {};
  explicit DhQGraphicsItemAnimation(QObject* x1) : DynamicQHandler(), QGraphicsItemAnimation(x1) {};
  void afterAnimationStep(qreal x1);
  void DhafterAnimationStep(qreal x1);
  void DvhafterAnimationStep(qreal x1);
  void beforeAnimationStep(qreal x1);
  void DhbeforeAnimationStep(qreal x1);
  void DvhbeforeAnimationStep(qreal x1);
  ~DhQGraphicsItemAnimation(){}
