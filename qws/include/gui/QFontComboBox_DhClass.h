...
class DhQFontComboBox : public DynamicQHandler, public QFontComboBox
{
private: 
...
public:
  ...
  explicit DhQFontComboBox() : DynamicQHandler(), QFontComboBox() {};
  explicit DhQFontComboBox(QWidget* x1) : DynamicQHandler(), QFontComboBox(x1) {};
  ...
  void DhhidePopup();
  void DvhhidePopup();
  void initStyleOption(QStyleOptionComboBox* x1) const;
  void DhinitStyleOption(QStyleOptionComboBox* x1) const;
  void DvhinitStyleOption(QStyleOptionComboBox* x1) const;
