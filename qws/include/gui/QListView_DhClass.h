...
class DhQListView : public DynamicQHandler, public QListView
{
private: 
...
public:
  ...
  explicit DhQListView() : DynamicQHandler(), QListView() {};
  explicit DhQListView(QWidget* x1) : DynamicQHandler(), QListView(x1) {};
