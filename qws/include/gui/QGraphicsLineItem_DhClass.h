/////////////////////////////////////////////////////////////////////////////
//      
//      File      : QGraphicsLineItem_DhClass.h
...
class DhQGraphicsLineItem : public DynamicQHandler, public QGraphicsLineItem
{
private: 
...
public:
  ...
  explicit DhQGraphicsLineItem() : DynamicQHandler(), QGraphicsLineItem() {};
  explicit DhQGraphicsLineItem(const QLineF& x1) : DynamicQHandler(), QGraphicsLineItem(x1) {};
  explicit DhQGraphicsLineItem(QGraphicsItem* x1) : DynamicQHandler(), QGraphicsLineItem(x1) {};
  explicit DhQGraphicsLineItem(QGraphicsTextItem* x1) : DynamicQHandler(), QGraphicsLineItem(x1) {};
  explicit DhQGraphicsLineItem(const QLineF& x1, QGraphicsItem* x2) : DynamicQHandler(), QGraphicsLineItem(x1, x2) {};
  explicit DhQGraphicsLineItem(const QLineF& x1, QGraphicsTextItem* x2) : DynamicQHandler(), QGraphicsLineItem(x1, x2) {};
  explicit DhQGraphicsLineItem(QGraphicsItem* x1, QGraphicsScene* x2) : DynamicQHandler(), QGraphicsLineItem(x1, x2) {};
  explicit DhQGraphicsLineItem(QGraphicsTextItem* x1, QGraphicsScene* x2) : DynamicQHandler(), QGraphicsLineItem(x1, x2) {};
  explicit DhQGraphicsLineItem(const QLineF& x1, QGraphicsItem* x2, QGraphicsScene* x3) : DynamicQHandler(), QGraphicsLineItem(x1, x2, x3) {};
  explicit DhQGraphicsLineItem(const QLineF& x1, QGraphicsTextItem* x2, QGraphicsScene* x3) : DynamicQHandler(), QGraphicsLineItem(x1, x2, x3) {};
