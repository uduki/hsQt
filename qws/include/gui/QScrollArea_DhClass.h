...
class DhQScrollArea : public DynamicQHandler, public QScrollArea
{
private: 
...
public:
  ...
  explicit DhQScrollArea() : DynamicQHandler(), QScrollArea() {};
  explicit DhQScrollArea(QWidget* x1) : DynamicQHandler(), QScrollArea(x1) {};
