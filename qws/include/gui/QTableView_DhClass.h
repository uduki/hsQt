...
class DhQTableView : public DynamicQHandler, public QTableView
{
private: 
...
public:
  ...
  explicit DhQTableView() : DynamicQHandler(), QTableView() {};
  explicit DhQTableView(QWidget* x1) : DynamicQHandler(), QTableView(x1) {};
