...
class DhQBoxLayout : public DynamicQHandler, public QBoxLayout
{
private: 
...
public:
  ...
  explicit DhQBoxLayout(QBoxLayout::Direction x1) : DynamicQHandler(), QBoxLayout(x1) {};
  explicit DhQBoxLayout(QBoxLayout::Direction x1, QWidget* x2) : DynamicQHandler(), QBoxLayout(x1, x2) {};
