...
class DhQDialog : public DynamicQHandler, public QDialog
{
private: 
...
public:
  ...
  explicit DhQDialog() : DynamicQHandler(), QDialog() {};
  explicit DhQDialog(QWidget* x1) : DynamicQHandler(), QDialog(x1) {};
  explicit DhQDialog(QWidget* x1, Qt::WindowFlags x2) : DynamicQHandler(), QDialog(x1, x2) {};
  void accept();
  void Dhaccept();
  void Dvhaccept();
