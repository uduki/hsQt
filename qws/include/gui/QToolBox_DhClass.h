...
class DhQToolBox : public DynamicQHandler, public QToolBox
{
private: 
...
public:
  ...
  explicit DhQToolBox() : DynamicQHandler(), QToolBox() {};
  explicit DhQToolBox(QWidget* x1) : DynamicQHandler(), QToolBox(x1) {};
  explicit DhQToolBox(QWidget* x1, Qt::WindowFlags x2) : DynamicQHandler(), QToolBox(x1, x2) {};
  ...
  void itemInserted(int x1);
  void DhitemInserted(int x1);
  void DvhitemInserted(int x1);
  void itemRemoved(int x1);
  void DhitemRemoved(int x1);
  void DvhitemRemoved(int x1);
