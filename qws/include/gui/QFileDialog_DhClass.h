...
class DhQFileDialog : public DynamicQHandler, public QFileDialog
{
private: 
...
public:
  ...
  explicit DhQFileDialog() : DynamicQHandler(), QFileDialog() {};
  explicit DhQFileDialog(QWidget* x1) : DynamicQHandler(), QFileDialog(x1) {};
  explicit DhQFileDialog(QWidget* x1, const QString& x2) : DynamicQHandler(), QFileDialog(x1, x2) {};
  explicit DhQFileDialog(QWidget* x1, Qt::WindowFlags x2) : DynamicQHandler(), QFileDialog(x1, x2) {};
  explicit DhQFileDialog(QWidget* x1, const QString& x2, const QString& x3) : DynamicQHandler(), QFileDialog(x1, x2, x3) {};
  explicit DhQFileDialog(QWidget* x1, const QString& x2, const QString& x3, const QString& x4) : DynamicQHandler(), QFileDialog(x1, x2, x3, x4) {};
  void accept();
  void Dhaccept();
  void Dvhaccept();
