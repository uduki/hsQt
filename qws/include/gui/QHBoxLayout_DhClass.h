...
class DhQHBoxLayout : public DynamicQHandler, public QHBoxLayout
{
private: 
...
public:
  ...
  explicit DhQHBoxLayout() : DynamicQHandler(), QHBoxLayout() {};
  explicit DhQHBoxLayout(QWidget* x1) : DynamicQHandler(), QHBoxLayout(x1) {};
  ~DhQHBoxLayout(){}
