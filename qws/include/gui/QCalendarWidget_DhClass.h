/////////////////////////////////////////////////////////////////////////////
//      
//      File      : QCalendarWidget_DhClass.h
...
class DhQCalendarWidget : public DynamicQHandler, public QCalendarWidget
{
private: 
...
public:
  ...
  explicit DhQCalendarWidget() : DynamicQHandler(), QCalendarWidget() {};
  explicit DhQCalendarWidget(QWidget* x1) : DynamicQHandler(), QCalendarWidget(x1) {};
  ...
  void paintCell(QPainter* x1, const QRect& x2, const QDate& x3) const;
  void DhpaintCell(QPainter* x1, const QRect& x2, const QDate& x3) const;
  void DvhpaintCell(QPainter* x1, const QRect& x2, const QDate& x3) const;
