...
class DhQMenu : public DynamicQHandler, public QMenu
{
private: 
...
public:
  ...
  explicit DhQMenu() : DynamicQHandler(), QMenu() {};
  explicit DhQMenu(QWidget* x1) : DynamicQHandler(), QMenu(x1) {};
  explicit DhQMenu(const QString& x1) : DynamicQHandler(), QMenu(x1) {};
  explicit DhQMenu(const QString& x1, QWidget* x2) : DynamicQHandler(), QMenu(x1, x2) {};
  ...
  void initStyleOption(QStyleOptionMenuItem* x1, const QAction* x2) const;
  void DhinitStyleOption(QStyleOptionMenuItem* x1, const QAction* x2) const;
  void DvhinitStyleOption(QStyleOptionMenuItem* x1, const QAction* x2) const;
