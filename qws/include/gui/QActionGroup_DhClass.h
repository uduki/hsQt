...
class DhQActionGroup : public DynamicQHandler, public QActionGroup
{
private: 
...
public:
  ...
  explicit DhQActionGroup(QObject* x1) : DynamicQHandler(), QActionGroup(x1) {};
  ~DhQActionGroup(){}
