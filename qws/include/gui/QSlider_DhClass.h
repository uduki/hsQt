...
class DhQSlider : public DynamicQHandler, public QSlider
{
private: 
...
public:
  ...
  explicit DhQSlider() : DynamicQHandler(), QSlider() {};
  explicit DhQSlider(QWidget* x1) : DynamicQHandler(), QSlider(x1) {};
  explicit DhQSlider(Qt::Orientation x1) : DynamicQHandler(), QSlider(x1) {};
  explicit DhQSlider(Qt::Orientation x1, QWidget* x2) : DynamicQHandler(), QSlider(x1, x2) {};
