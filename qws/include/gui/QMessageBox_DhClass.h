...
class DhQMessageBox : public DynamicQHandler, public QMessageBox
{
private: 
...
public:
  ...
  explicit DhQMessageBox() : DynamicQHandler(), QMessageBox() {};
  explicit DhQMessageBox(QWidget* x1) : DynamicQHandler(), QMessageBox(x1) {};
  explicit DhQMessageBox(QMessageBox::Icon x1, const QString& x2, const QString& x3) : DynamicQHandler(), QMessageBox(x1, x2, x3) {};
  explicit DhQMessageBox(QMessageBox::Icon x1, const QString& x2, const QString& x3, QMessageBox::StandardButtons x4) : DynamicQHandler(), QMessageBox(x1, x2, x3, x4) {};
  explicit DhQMessageBox(QMessageBox::Icon x1, const QString& x2, const QString& x3, QMessageBox::StandardButtons x4, QWidget* x5) : DynamicQHandler(), QMessageBox(x1, x2, x3, x4, x5) {};
  explicit DhQMessageBox(const QString& x1, const QString& x2, QMessageBox::Icon x3, int x4, int x5, int x6) : DynamicQHandler(), QMessageBox(x1, x2, x3, x4, x5, x6) {};
  explicit DhQMessageBox(QMessageBox::Icon x1, const QString& x2, const QString& x3, QMessageBox::StandardButtons x4, QWidget* x5, Qt::WindowFlags x6) : DynamicQHandler(), QMessageBox(x1, x2, x3, x4, x5, x6) {};
  explicit DhQMessageBox(const QString& x1, const QString& x2, QMessageBox::Icon x3, int x4, int x5, int x6, QWidget* x7) : DynamicQHandler(), QMessageBox(x1, x2, x3, x4, x5, x6, x7) {};
  explicit DhQMessageBox(const QString& x1, const QString& x2, QMessageBox::Icon x3, int x4, int x5, int x6, QWidget* x7, Qt::WindowFlags x8) : DynamicQHandler(), QMessageBox(x1, x2, x3, x4, x5, x6, x7, x8) {};
