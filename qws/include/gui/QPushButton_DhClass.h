...
class DhQPushButton : public DynamicQHandler, public QPushButton
{
private: 
...
public:
  ...
  explicit DhQPushButton() : DynamicQHandler(), QPushButton() {};
  explicit DhQPushButton(QWidget* x1) : DynamicQHandler(), QPushButton(x1) {};
  explicit DhQPushButton(const QString& x1) : DynamicQHandler(), QPushButton(x1) {};
  explicit DhQPushButton(const QIcon& x1, const QString& x2) : DynamicQHandler(), QPushButton(x1, x2) {};
  explicit DhQPushButton(const QString& x1, QWidget* x2) : DynamicQHandler(), QPushButton(x1, x2) {};
  explicit DhQPushButton(const QIcon& x1, const QString& x2, QWidget* x3) : DynamicQHandler(), QPushButton(x1, x2, x3) {};
  ...
  void initStyleOption(QStyleOptionButton* x1) const;
  void DhinitStyleOption(QStyleOptionButton* x1) const;
  void DvhinitStyleOption(QStyleOptionButton* x1) const;
  ...
  void checkStateSet();
  void DhcheckStateSet();
  void DvhcheckStateSet();
  bool hitButton(const QPoint& x1) const;
  bool DhhitButton(const QPoint& x1) const;
  bool DvhhitButton(const QPoint& x1) const;
  ...
  void nextCheckState();
  void DhnextCheckState();
  void DvhnextCheckState();
