...
class DhQCompleter : public DynamicQHandler, public QCompleter
{
private: 
...
public:
  ...
  explicit DhQCompleter() : DynamicQHandler(), QCompleter() {};
  explicit DhQCompleter(const QStringList& x1) : DynamicQHandler(), QCompleter(x1) {};
  explicit DhQCompleter(QObject* x1) : DynamicQHandler(), QCompleter(x1) {};
  explicit DhQCompleter(QAbstractItemModel* x1) : DynamicQHandler(), QCompleter(x1) {};
  explicit DhQCompleter(QAbstractItemModel* x1, QObject* x2) : DynamicQHandler(), QCompleter(x1, x2) {};
  explicit DhQCompleter(const QStringList& x1, QObject* x2) : DynamicQHandler(), QCompleter(x1, x2) {};
  ...
  QString pathFromIndex(const QModelIndex& x1) const;
  QString DhpathFromIndex(const QModelIndex& x1) const;
  QString DvhpathFromIndex(const QModelIndex& x1) const;
  ~DhQCompleter(){}
