/////////////////////////////////////////////////////////////////////////////
//      
//      File      : QGraphicsSimpleTextItem_DhClass.h
...
class DhQGraphicsSimpleTextItem : public DynamicQHandler, public QGraphicsSimpleTextItem
{
private: 
...
public:
  ...
  explicit DhQGraphicsSimpleTextItem() : DynamicQHandler(), QGraphicsSimpleTextItem() {};
  explicit DhQGraphicsSimpleTextItem(const QString& x1) : DynamicQHandler(), QGraphicsSimpleTextItem(x1) {};
  explicit DhQGraphicsSimpleTextItem(QGraphicsItem* x1) : DynamicQHandler(), QGraphicsSimpleTextItem(x1) {};
  explicit DhQGraphicsSimpleTextItem(QGraphicsTextItem* x1) : DynamicQHandler(), QGraphicsSimpleTextItem(x1) {};
  explicit DhQGraphicsSimpleTextItem(QGraphicsItem* x1, QGraphicsScene* x2) : DynamicQHandler(), QGraphicsSimpleTextItem(x1, x2) {};
  explicit DhQGraphicsSimpleTextItem(QGraphicsTextItem* x1, QGraphicsScene* x2) : DynamicQHandler(), QGraphicsSimpleTextItem(x1, x2) {};
  explicit DhQGraphicsSimpleTextItem(const QString& x1, QGraphicsItem* x2) : DynamicQHandler(), QGraphicsSimpleTextItem(x1, x2) {};
  explicit DhQGraphicsSimpleTextItem(const QString& x1, QGraphicsTextItem* x2) : DynamicQHandler(), QGraphicsSimpleTextItem(x1, x2) {};
  explicit DhQGraphicsSimpleTextItem(const QString& x1, QGraphicsItem* x2, QGraphicsScene* x3) : DynamicQHandler(), QGraphicsSimpleTextItem(x1, x2, x3) {};
  explicit DhQGraphicsSimpleTextItem(const QString& x1, QGraphicsTextItem* x2, QGraphicsScene* x3) : DynamicQHandler(), QGraphicsSimpleTextItem(x1, x2, x3) {};
