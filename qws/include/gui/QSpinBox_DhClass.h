...
class DhQSpinBox : public DynamicQHandler, public QSpinBox
{
private: 
...
public:
  ...
  explicit DhQSpinBox() : DynamicQHandler(), QSpinBox() {};
  explicit DhQSpinBox(QWidget* x1) : DynamicQHandler(), QSpinBox(x1) {};
  bool event(QEvent* x1);
  bool Dhevent(QEvent* x1);
  bool Dvhevent(QEvent* x1);
  int valueFromText(const QString& x1) const;
  int DhvalueFromText(const QString& x1) const;
  int DvhvalueFromText(const QString& x1) const;
  ~DhQSpinBox(){}
