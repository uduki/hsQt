...
class DhQLayout : public DynamicQHandler, public QLayout
{
private: 
...
public:
  ...
  explicit DhQLayout() : DynamicQHandler(), QLayout() {};
  explicit DhQLayout(QWidget* x1) : DynamicQHandler(), QLayout(x1) {};
