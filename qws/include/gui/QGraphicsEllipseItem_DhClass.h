/////////////////////////////////////////////////////////////////////////////
//      
//      File      : QGraphicsEllipseItem_DhClass.h
...
class DhQGraphicsEllipseItem : public DynamicQHandler, public QGraphicsEllipseItem
{
private: 
...
public:
  ...
  explicit DhQGraphicsEllipseItem() : DynamicQHandler(), QGraphicsEllipseItem() {};
  explicit DhQGraphicsEllipseItem(const QRectF& x1) : DynamicQHandler(), QGraphicsEllipseItem(x1) {};
  explicit DhQGraphicsEllipseItem(QGraphicsItem* x1) : DynamicQHandler(), QGraphicsEllipseItem(x1) {};
  explicit DhQGraphicsEllipseItem(QGraphicsTextItem* x1) : DynamicQHandler(), QGraphicsEllipseItem(x1) {};
  explicit DhQGraphicsEllipseItem(const QRectF& x1, QGraphicsItem* x2) : DynamicQHandler(), QGraphicsEllipseItem(x1, x2) {};
  explicit DhQGraphicsEllipseItem(const QRectF& x1, QGraphicsTextItem* x2) : DynamicQHandler(), QGraphicsEllipseItem(x1, x2) {};
  explicit DhQGraphicsEllipseItem(QGraphicsItem* x1, QGraphicsScene* x2) : DynamicQHandler(), QGraphicsEllipseItem(x1, x2) {};
  explicit DhQGraphicsEllipseItem(QGraphicsTextItem* x1, QGraphicsScene* x2) : DynamicQHandler(), QGraphicsEllipseItem(x1, x2) {};
  explicit DhQGraphicsEllipseItem(const QRectF& x1, QGraphicsItem* x2, QGraphicsScene* x3) : DynamicQHandler(), QGraphicsEllipseItem(x1, x2, x3) {};
  explicit DhQGraphicsEllipseItem(const QRectF& x1, QGraphicsTextItem* x2, QGraphicsScene* x3) : DynamicQHandler(), QGraphicsEllipseItem(x1, x2, x3) {};
