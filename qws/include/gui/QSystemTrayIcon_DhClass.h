/////////////////////////////////////////////////////////////////////////////
//      
//      File      : QSystemTrayIcon_DhClass.h
...
class DhQSystemTrayIcon : public DynamicQHandler, public QSystemTrayIcon
{
private: 
...
public:
  ...
  explicit DhQSystemTrayIcon() : DynamicQHandler(), QSystemTrayIcon() {};
  explicit DhQSystemTrayIcon(QObject* x1) : DynamicQHandler(), QSystemTrayIcon(x1) {};
  explicit DhQSystemTrayIcon(const QIcon& x1) : DynamicQHandler(), QSystemTrayIcon(x1) {};
  explicit DhQSystemTrayIcon(const QIcon& x1, QObject* x2) : DynamicQHandler(), QSystemTrayIcon(x1, x2) {};
