...
class DhQTextDocument : public DynamicQHandler, public QTextDocument
{
private: 
...
public:
  ...
  explicit DhQTextDocument() : DynamicQHandler(), QTextDocument() {};
  explicit DhQTextDocument(const QString& x1) : DynamicQHandler(), QTextDocument(x1) {};
  explicit DhQTextDocument(QObject* x1) : DynamicQHandler(), QTextDocument(x1) {};
  explicit DhQTextDocument(const QString& x1, QObject* x2) : DynamicQHandler(), QTextDocument(x1, x2) {};
  void clear();
  void Dhclear();
  void Dvhclear();
  QTextObject* createObject(const QTextFormat& x1);
  QTextObject* DhcreateObject(const QTextFormat& x1);
  QTextObject* DvhcreateObject(const QTextFormat& x1);
