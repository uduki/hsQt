...
class DhQDirModel : public DynamicQHandler, public QDirModel
{
private: 
...
public:
  ...
  explicit DhQDirModel() : DynamicQHandler(), QDirModel() {};
  explicit DhQDirModel(QObject* x1) : DynamicQHandler(), QDirModel(x1) {};
  explicit DhQDirModel(const QStringList& x1, QDir::Filters x2, QDir::SortFlags x3) : DynamicQHandler(), QDirModel(x1, x2, x3) {};
  explicit DhQDirModel(const QStringList& x1, QDir::Filters x2, QDir::SortFlags x3, QObject* x4) : DynamicQHandler(), QDirModel(x1, x2, x3, x4) {};
  ...
  QModelIndex index(int x1, int x2) const;
  QModelIndex Dhindex(int x1, int x2) const;
  QModelIndex Dvhindex(int x1, int x2) const;
