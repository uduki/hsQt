...
class DhQLCDNumber : public DynamicQHandler, public QLCDNumber
{
private: 
...
public:
  ...
  explicit DhQLCDNumber() : DynamicQHandler(), QLCDNumber() {};
  explicit DhQLCDNumber(QWidget* x1) : DynamicQHandler(), QLCDNumber(x1) {};
  explicit DhQLCDNumber(uint x1) : DynamicQHandler(), QLCDNumber(x1) {};
  explicit DhQLCDNumber(uint x1, QWidget* x2) : DynamicQHandler(), QLCDNumber(x1, x2) {};
