...
class DhQPrintDialog : public DynamicQHandler, public QPrintDialog
{
private: 
...
public:
  ...
  explicit DhQPrintDialog(QPrinter* x1) : DynamicQHandler(), QPrintDialog(x1) {};
  explicit DhQPrintDialog(QPrinter* x1, QWidget* x2) : DynamicQHandler(), QPrintDialog(x1, x2) {};
