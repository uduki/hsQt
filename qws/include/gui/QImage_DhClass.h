...
class DhQImage : public DynamicQHandler, public QImage
{
private: 
...
public:
  ...
  explicit DhQImage() : DynamicQHandler(), QImage() {};
  explicit DhQImage(const char* x1) : DynamicQHandler(), QImage(x1) {};
  explicit DhQImage(const QString& x1) : DynamicQHandler(), QImage(x1) {};
  explicit DhQImage(const QImage& x1) : DynamicQHandler(), QImage(x1) {};
  explicit DhQImage(const QString& x1, const char* x2) : DynamicQHandler(), QImage(x1, x2) {};
  explicit DhQImage(const QSize& x1, QImage::Format x2) : DynamicQHandler(), QImage(x1, x2) {};
  explicit DhQImage(const char* x1, const char* x2) : DynamicQHandler(), QImage(x1, x2) {};
  explicit DhQImage(int x1, int x2, QImage::Format x3) : DynamicQHandler(), QImage(x1, x2, x3) {};
  int devType() const;
  int DhdevType() const;
