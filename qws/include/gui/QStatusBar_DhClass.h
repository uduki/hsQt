...
class DhQStatusBar : public DynamicQHandler, public QStatusBar
{
private: 
...
public:
  ...
  explicit DhQStatusBar() : DynamicQHandler(), QStatusBar() {};
  explicit DhQStatusBar(QWidget* x1) : DynamicQHandler(), QStatusBar(x1) {};
