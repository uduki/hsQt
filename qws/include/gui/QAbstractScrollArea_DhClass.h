/////////////////////////////////////////////////////////////////////////////
//      
//      File      : QAbstractScrollArea_DhClass.h
...
class DhQAbstractScrollArea : public DynamicQHandler, public QAbstractScrollArea
{
private: 
...
public:
  ...
  explicit DhQAbstractScrollArea() : DynamicQHandler(), QAbstractScrollArea() {};
  explicit DhQAbstractScrollArea(QWidget* x1) : DynamicQHandler(), QAbstractScrollArea(x1) {};
