/////////////////////////////////////////////////////////////////////////////
//      
//      File      : QGraphicsPathItem_DhClass.h
...
class DhQGraphicsPathItem : public DynamicQHandler, public QGraphicsPathItem
{
private: 
...
public:
  ...
  explicit DhQGraphicsPathItem() : DynamicQHandler(), QGraphicsPathItem() {};
  explicit DhQGraphicsPathItem(const QPainterPath& x1) : DynamicQHandler(), QGraphicsPathItem(x1) {};
  explicit DhQGraphicsPathItem(QGraphicsItem* x1) : DynamicQHandler(), QGraphicsPathItem(x1) {};
  explicit DhQGraphicsPathItem(QGraphicsTextItem* x1) : DynamicQHandler(), QGraphicsPathItem(x1) {};
  explicit DhQGraphicsPathItem(QGraphicsItem* x1, QGraphicsScene* x2) : DynamicQHandler(), QGraphicsPathItem(x1, x2) {};
  explicit DhQGraphicsPathItem(QGraphicsTextItem* x1, QGraphicsScene* x2) : DynamicQHandler(), QGraphicsPathItem(x1, x2) {};
  explicit DhQGraphicsPathItem(const QPainterPath& x1, QGraphicsItem* x2) : DynamicQHandler(), QGraphicsPathItem(x1, x2) {};
  explicit DhQGraphicsPathItem(const QPainterPath& x1, QGraphicsTextItem* x2) : DynamicQHandler(), QGraphicsPathItem(x1, x2) {};
  explicit DhQGraphicsPathItem(const QPainterPath& x1, QGraphicsItem* x2, QGraphicsScene* x3) : DynamicQHandler(), QGraphicsPathItem(x1, x2, x3) {};
  explicit DhQGraphicsPathItem(const QPainterPath& x1, QGraphicsTextItem* x2, QGraphicsScene* x3) : DynamicQHandler(), QGraphicsPathItem(x1, x2, x3) {};
