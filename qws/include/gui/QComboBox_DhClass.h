...
class DhQComboBox : public DynamicQHandler, public QComboBox
{
private: 
...
public:
  ...
  explicit DhQComboBox() : DynamicQHandler(), QComboBox() {};
  explicit DhQComboBox(QWidget* x1) : DynamicQHandler(), QComboBox(x1) {};
