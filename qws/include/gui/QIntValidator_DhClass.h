...
class DhQIntValidator : public DynamicQHandler, public QIntValidator
{
private: 
...
public:
  ...
  explicit DhQIntValidator(QObject* x1) : DynamicQHandler(), QIntValidator(x1) {};
  explicit DhQIntValidator(int x1, int x2, QObject* x3) : DynamicQHandler(), QIntValidator(x1, x2, x3) {};
  void setRange(int x1, int x2);
  void DhsetRange(int x1, int x2);
  void DvhsetRange(int x1, int x2);
  ~DhQIntValidator(){}
