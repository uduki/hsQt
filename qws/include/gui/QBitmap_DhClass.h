...
class DhQBitmap : public DynamicQHandler, public QBitmap
{
private: 
...
public:
  ...
  explicit DhQBitmap() : DynamicQHandler(), QBitmap() {};
  explicit DhQBitmap(const QPixmap& x1) : DynamicQHandler(), QBitmap(x1) {};
  explicit DhQBitmap(const QSize& x1) : DynamicQHandler(), QBitmap(x1) {};
  explicit DhQBitmap(const QString& x1) : DynamicQHandler(), QBitmap(x1) {};
  explicit DhQBitmap(const QString& x1, const char* x2) : DynamicQHandler(), QBitmap(x1, x2) {};
  explicit DhQBitmap(int x1, int x2) : DynamicQHandler(), QBitmap(x1, x2) {};
  ~DhQBitmap(){}
  int devType() const;
  int DhdevType() const;
