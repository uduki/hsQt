...
class DhQUndoGroup : public DynamicQHandler, public QUndoGroup
{
private: 
...
public:
  ...
  explicit DhQUndoGroup() : DynamicQHandler(), QUndoGroup() {};
  explicit DhQUndoGroup(QObject* x1) : DynamicQHandler(), QUndoGroup(x1) {};
  ~DhQUndoGroup(){}
