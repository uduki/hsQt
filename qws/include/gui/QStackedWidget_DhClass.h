...
class DhQStackedWidget : public DynamicQHandler, public QStackedWidget
{
private: 
...
public:
  ...
  explicit DhQStackedWidget() : DynamicQHandler(), QStackedWidget() {};
  explicit DhQStackedWidget(QWidget* x1) : DynamicQHandler(), QStackedWidget(x1) {};
