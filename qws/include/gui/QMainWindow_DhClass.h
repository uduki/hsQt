...
class DhQMainWindow : public DynamicQHandler, public QMainWindow
{
private: 
...
public:
  ...
  explicit DhQMainWindow() : DynamicQHandler(), QMainWindow() {};
  explicit DhQMainWindow(QWidget* x1) : DynamicQHandler(), QMainWindow(x1) {};
  explicit DhQMainWindow(QWidget* x1, Qt::WindowFlags x2) : DynamicQHandler(), QMainWindow(x1, x2) {};
  ...
  QMenu* DhcreatePopupMenu();
  QMenu* DvhcreatePopupMenu();
