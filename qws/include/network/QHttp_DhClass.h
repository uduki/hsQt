...
class DhQHttp : public DynamicQHandler, public QHttp
{
private: 
...
public:
  ...
  explicit DhQHttp() : DynamicQHandler(), QHttp() {};
  explicit DhQHttp(const QString& x1) : DynamicQHandler(), QHttp(x1) {};
  explicit DhQHttp(QObject* x1) : DynamicQHandler(), QHttp(x1) {};
  explicit DhQHttp(const QString& x1, quint16 x2) : DynamicQHandler(), QHttp(x1, x2) {};
  explicit DhQHttp(const QString& x1, QHttp::ConnectionMode x2) : DynamicQHandler(), QHttp(x1, x2) {};
  explicit DhQHttp(const QString& x1, QHttp::ConnectionMode x2, quint16 x3) : DynamicQHandler(), QHttp(x1, x2, x3) {};
  explicit DhQHttp(const QString& x1, quint16 x2, QObject* x3) : DynamicQHandler(), QHttp(x1, x2, x3) {};
  explicit DhQHttp(const QString& x1, QHttp::ConnectionMode x2, quint16 x3, QObject* x4) : DynamicQHandler(), QHttp(x1, x2, x3, x4) {};
  ~DhQHttp(){}
