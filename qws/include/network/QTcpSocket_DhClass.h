...
class DhQTcpSocket : public DynamicQHandler, public QTcpSocket
{
private: 
...
public:
  ...
  explicit DhQTcpSocket() : DynamicQHandler(), QTcpSocket() {};
  explicit DhQTcpSocket(QObject* x1) : DynamicQHandler(), QTcpSocket(x1) {};
  ~DhQTcpSocket(){}
  bool atEnd() const;
  bool DhatEnd() const;
  bool DvhatEnd() const;
