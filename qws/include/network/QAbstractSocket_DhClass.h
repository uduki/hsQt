/////////////////////////////////////////////////////////////////////////////
//      
//      File      : QAbstractSocket_DhClass.h
...
class DhQAbstractSocket : public DynamicQHandler, public QAbstractSocket
{
private: 
...
public:
  ...
  explicit DhQAbstractSocket(QAbstractSocket::SocketType x1, QObject* x2) : DynamicQHandler(), QAbstractSocket(x1, x2) {};
  bool atEnd() const;
  bool DhatEnd() const;
  bool DvhatEnd() const;
