...
void DhQUndoStack::userDefined(int x1) const {
  void* ro_ptr;
  void* rf_ptr;
  if(handlerSetud(x1,(void*&)ro_ptr,(void*&)rf_ptr,0)) (*(void(*)(void*))rf_ptr)(ro_ptr);
}

QVariant* DhQUndoStack::userDefinedVariant(int x1, QVariant* x2) const {
  void* ro_ptr;
  void* rf_ptr;
...
void DhQUndoStack::childEvent(QChildEvent* x1) {
  void* ro_ptr;
  void* rf_ptr;
...
void DhQUndoStack::DhchildEvent(QChildEvent* x1) {
  return QObject::childEvent(x1);
}

void DhQUndoStack::DvhchildEvent(QChildEvent* x1) {
  return childEvent(x1);
}

void DhQUndoStack::connectNotify(const char* x1) {
  void* ro_ptr;
  void* rf_ptr;
...
void DhQUndoStack::DhconnectNotify(const char* x1) {
  return QObject::connectNotify(x1);
}

void DhQUndoStack::DvhconnectNotify(const char* x1) {
  return connectNotify(x1);
}

void DhQUndoStack::customEvent(QEvent* x1) {
  void* ro_ptr;
  void* rf_ptr;
...
void DhQUndoStack::DhcustomEvent(QEvent* x1) {
  return QObject::customEvent(x1);
}

void DhQUndoStack::DvhcustomEvent(QEvent* x1) {
  return customEvent(x1);
}

void DhQUndoStack::disconnectNotify(const char* x1) {
  void* ro_ptr;
  void* rf_ptr;
...
void DhQUndoStack::DhdisconnectNotify(const char* x1) {
  return QObject::disconnectNotify(x1);
}

void DhQUndoStack::DvhdisconnectNotify(const char* x1) {
  return disconnectNotify(x1);
}

bool DhQUndoStack::event(QEvent* x1) {
  void* ro_ptr;
  void* rf_ptr;
...
bool DhQUndoStack::Dhevent(QEvent* x1) {
  return QObject::event(x1);
}

bool DhQUndoStack::Dvhevent(QEvent* x1) {
  return event(x1);
}

bool DhQUndoStack::eventFilter(QObject* x1, QEvent* x2) {
  void* ro_ptr;
  void* rf_ptr;
...
bool DhQUndoStack::DheventFilter(QObject* x1, QEvent* x2) {
  return QObject::eventFilter(x1, x2);
}

bool DhQUndoStack::DvheventFilter(QObject* x1, QEvent* x2) {
  return eventFilter(x1, x2);
}

int DhQUndoStack::receivers(const char* x1) const {
  void* ro_ptr;
  void* rf_ptr;
...
int DhQUndoStack::Dhreceivers(const char* x1) const {
  return QObject::receivers(x1);
}

int DhQUndoStack::Dvhreceivers(const char* x1) const {
  return receivers(x1);
}

QObject* DhQUndoStack::sender() const {
  void* ro_ptr;
  void* rf_ptr;
...
QObject* DhQUndoStack::Dhsender() const {
  return QObject::sender();
}

QObject* DhQUndoStack::Dvhsender() const {
  return sender();
}

void DhQUndoStack::timerEvent(QTimerEvent* x1) {
  void* ro_ptr;
  void* rf_ptr;
...
void DhQUndoStack::DhtimerEvent(QTimerEvent* x1) {
  return QObject::timerEvent(x1);
}

void DhQUndoStack::DvhtimerEvent(QTimerEvent* x1) {
  return timerEvent(x1);
}

QHash <QByteArray, int> DhQUndoStack::initXhHash() {
...
QHash <QByteArray, int> DhQUndoStack::xhHash = DhQUndoStack::initXhHash();

bool DhQUndoStack::setDynamicQHandler(void * ro_ptr, char * eventId, void * rf_ptr, void * st_ptr, void * df_ptr) {
...
bool DhQUndoStack::setDynamicQHandlerud(int udtyp, void * ro_ptr, int eventId, void * rf_ptr, void * st_ptr, void * df_ptr) {
  if ((udtyp < 0) || (udtyp > 2)) {
    return false;
  }
...
bool DhQUndoStack::unSetDynamicQHandler(char * eventId) {
  QByteArray theHandler = QMetaObject::normalizedSignature(eventId);
  if (xhHash.contains(theHandler)) {
    int thir = xhHash.value(theHandler);
...
bool DhQUndoStack::unSetDynamicQHandlerud(int udtyp, int eventId) {
  if ((udtyp < 0) || (udtyp > 2)) {
    return false;
  }
