...
void DhQMovie::userDefined(int x1) const {
  void* ro_ptr;
  void* rf_ptr;
  if(handlerSetud(x1,(void*&)ro_ptr,(void*&)rf_ptr,0)) (*(void(*)(void*))rf_ptr)(ro_ptr);
}

QVariant* DhQMovie::userDefinedVariant(int x1, QVariant* x2) const {
  void* ro_ptr;
  void* rf_ptr;
...
void DhQMovie::childEvent(QChildEvent* x1) {
  void* ro_ptr;
  void* rf_ptr;
...
void DhQMovie::DhchildEvent(QChildEvent* x1) {
  return QObject::childEvent(x1);
}

void DhQMovie::DvhchildEvent(QChildEvent* x1) {
  return childEvent(x1);
}

void DhQMovie::connectNotify(const char* x1) {
  void* ro_ptr;
  void* rf_ptr;
...
void DhQMovie::DhconnectNotify(const char* x1) {
  return QObject::connectNotify(x1);
}

void DhQMovie::DvhconnectNotify(const char* x1) {
  return connectNotify(x1);
}

void DhQMovie::customEvent(QEvent* x1) {
  void* ro_ptr;
  void* rf_ptr;
...
void DhQMovie::DhcustomEvent(QEvent* x1) {
  return QObject::customEvent(x1);
}

void DhQMovie::DvhcustomEvent(QEvent* x1) {
  return customEvent(x1);
}

void DhQMovie::disconnectNotify(const char* x1) {
  void* ro_ptr;
  void* rf_ptr;
...
void DhQMovie::DhdisconnectNotify(const char* x1) {
  return QObject::disconnectNotify(x1);
}

void DhQMovie::DvhdisconnectNotify(const char* x1) {
  return disconnectNotify(x1);
}

bool DhQMovie::event(QEvent* x1) {
  void* ro_ptr;
  void* rf_ptr;
...
bool DhQMovie::Dhevent(QEvent* x1) {
  return QObject::event(x1);
}

bool DhQMovie::Dvhevent(QEvent* x1) {
  return event(x1);
}

bool DhQMovie::eventFilter(QObject* x1, QEvent* x2) {
  void* ro_ptr;
  void* rf_ptr;
...
bool DhQMovie::DheventFilter(QObject* x1, QEvent* x2) {
  return QObject::eventFilter(x1, x2);
}

bool DhQMovie::DvheventFilter(QObject* x1, QEvent* x2) {
  return eventFilter(x1, x2);
}

int DhQMovie::receivers(const char* x1) const {
  void* ro_ptr;
  void* rf_ptr;
...
int DhQMovie::Dhreceivers(const char* x1) const {
  return QObject::receivers(x1);
}

int DhQMovie::Dvhreceivers(const char* x1) const {
  return receivers(x1);
}

QObject* DhQMovie::sender() const {
  void* ro_ptr;
  void* rf_ptr;
...
QObject* DhQMovie::Dhsender() const {
  return QObject::sender();
}

QObject* DhQMovie::Dvhsender() const {
  return sender();
}

void DhQMovie::timerEvent(QTimerEvent* x1) {
  void* ro_ptr;
  void* rf_ptr;
...
void DhQMovie::DhtimerEvent(QTimerEvent* x1) {
  return QObject::timerEvent(x1);
}

void DhQMovie::DvhtimerEvent(QTimerEvent* x1) {
  return timerEvent(x1);
}

QHash <QByteArray, int> DhQMovie::initXhHash() {
...
QHash <QByteArray, int> DhQMovie::xhHash = DhQMovie::initXhHash();

bool DhQMovie::setDynamicQHandler(void * ro_ptr, char * eventId, void * rf_ptr, void * st_ptr, void * df_ptr) {
...
bool DhQMovie::setDynamicQHandlerud(int udtyp, void * ro_ptr, int eventId, void * rf_ptr, void * st_ptr, void * df_ptr) {
  if ((udtyp < 0) || (udtyp > 2)) {
    return false;
  }
...
bool DhQMovie::unSetDynamicQHandler(char * eventId) {
  QByteArray theHandler = QMetaObject::normalizedSignature(eventId);
  if (xhHash.contains(theHandler)) {
    int thir = xhHash.value(theHandler);
...
bool DhQMovie::unSetDynamicQHandlerud(int udtyp, int eventId) {
  if ((udtyp < 0) || (udtyp > 2)) {
    return false;
  }
