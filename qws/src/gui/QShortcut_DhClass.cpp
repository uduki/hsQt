...
void DhQShortcut::userDefined(int x1) const {
  void* ro_ptr;
  void* rf_ptr;
  if(handlerSetud(x1,(void*&)ro_ptr,(void*&)rf_ptr,0)) (*(void(*)(void*))rf_ptr)(ro_ptr);
}

QVariant* DhQShortcut::userDefinedVariant(int x1, QVariant* x2) const {
  void* ro_ptr;
  void* rf_ptr;
...
bool DhQShortcut::event(QEvent* x1) {
  void* ro_ptr;
  void* rf_ptr;
  ...
  return QShortcut::event(x1);
}

bool DhQShortcut::Dhevent(QEvent* x1) {
  return QShortcut::event(x1);
}

bool DhQShortcut::Dvhevent(QEvent* x1) {
  return event(x1);
}

void DhQShortcut::childEvent(QChildEvent* x1) {
  void* ro_ptr;
  void* rf_ptr;
...
void DhQShortcut::DhchildEvent(QChildEvent* x1) {
  return QObject::childEvent(x1);
}
...
void DhQShortcut::connectNotify(const char* x1) {
  void* ro_ptr;
  void* rf_ptr;
...
void DhQShortcut::DhconnectNotify(const char* x1) {
  return QObject::connectNotify(x1);
}

void DhQShortcut::DvhconnectNotify(const char* x1) {
  return connectNotify(x1);
}

void DhQShortcut::customEvent(QEvent* x1) {
  void* ro_ptr;
  void* rf_ptr;
...
void DhQShortcut::DhcustomEvent(QEvent* x1) {
  return QObject::customEvent(x1);
}

void DhQShortcut::DvhcustomEvent(QEvent* x1) {
  return customEvent(x1);
}

void DhQShortcut::disconnectNotify(const char* x1) {
  void* ro_ptr;
  void* rf_ptr;
...
void DhQShortcut::DhdisconnectNotify(const char* x1) {
  return QObject::disconnectNotify(x1);
}

void DhQShortcut::DvhdisconnectNotify(const char* x1) {
  return disconnectNotify(x1);
}

bool DhQShortcut::eventFilter(QObject* x1, QEvent* x2) {
  void* ro_ptr;
  void* rf_ptr;
...
bool DhQShortcut::DheventFilter(QObject* x1, QEvent* x2) {
  return QObject::eventFilter(x1, x2);
}
...
int DhQShortcut::receivers(const char* x1) const {
  void* ro_ptr;
  void* rf_ptr;
...
int DhQShortcut::Dhreceivers(const char* x1) const {
  return QObject::receivers(x1);
}

int DhQShortcut::Dvhreceivers(const char* x1) const {
  return receivers(x1);
}

QObject* DhQShortcut::sender() const {
  void* ro_ptr;
  void* rf_ptr;
...
QObject* DhQShortcut::Dhsender() const {
  return QObject::sender();
}

QObject* DhQShortcut::Dvhsender() const {
  return sender();
}

void DhQShortcut::timerEvent(QTimerEvent* x1) {
  void* ro_ptr;
  void* rf_ptr;
...
void DhQShortcut::DhtimerEvent(QTimerEvent* x1) {
  return QObject::timerEvent(x1);
}

void DhQShortcut::DvhtimerEvent(QTimerEvent* x1) {
  return timerEvent(x1);
}

QHash <QByteArray, int> DhQShortcut::initXhHash() {
...
QHash <QByteArray, int> DhQShortcut::xhHash = DhQShortcut::initXhHash();

bool DhQShortcut::setDynamicQHandler(void * ro_ptr, char * eventId, void * rf_ptr, void * st_ptr, void * df_ptr) {
...
bool DhQShortcut::setDynamicQHandlerud(int udtyp, void * ro_ptr, int eventId, void * rf_ptr, void * st_ptr, void * df_ptr) {
  if ((udtyp < 0) || (udtyp > 2)) {
    return false;
  }
...
bool DhQShortcut::unSetDynamicQHandler(char * eventId) {
  QByteArray theHandler = QMetaObject::normalizedSignature(eventId);
  if (xhHash.contains(theHandler)) {
    int thir = xhHash.value(theHandler);
...
bool DhQShortcut::unSetDynamicQHandlerud(int udtyp, int eventId) {
  if ((udtyp < 0) || (udtyp > 2)) {
    return false;
  }
