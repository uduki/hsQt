...
#include <gui/QDrag_DhClass.h>

void DhQDrag::userDefined(int x1) const {
  void* ro_ptr;
  void* rf_ptr;
  if(handlerSetud(x1,(void*&)ro_ptr,(void*&)rf_ptr,0)) (*(void(*)(void*))rf_ptr)(ro_ptr);
}

QVariant* DhQDrag::userDefinedVariant(int x1, QVariant* x2) const {
  void* ro_ptr;
  void* rf_ptr;
...
void DhQDrag::childEvent(QChildEvent* x1) {
  void* ro_ptr;
  void* rf_ptr;
...
void DhQDrag::DhchildEvent(QChildEvent* x1) {
  return QObject::childEvent(x1);
}

void DhQDrag::DvhchildEvent(QChildEvent* x1) {
  return childEvent(x1);
}

void DhQDrag::connectNotify(const char* x1) {
  void* ro_ptr;
  void* rf_ptr;
...
void DhQDrag::DhconnectNotify(const char* x1) {
  return QObject::connectNotify(x1);
}

void DhQDrag::DvhconnectNotify(const char* x1) {
  return connectNotify(x1);
}

void DhQDrag::customEvent(QEvent* x1) {
  void* ro_ptr;
  void* rf_ptr;
...
void DhQDrag::DhcustomEvent(QEvent* x1) {
  return QObject::customEvent(x1);
}

void DhQDrag::DvhcustomEvent(QEvent* x1) {
  return customEvent(x1);
}

void DhQDrag::disconnectNotify(const char* x1) {
  void* ro_ptr;
  void* rf_ptr;
...
void DhQDrag::DhdisconnectNotify(const char* x1) {
  return QObject::disconnectNotify(x1);
}

void DhQDrag::DvhdisconnectNotify(const char* x1) {
  return disconnectNotify(x1);
}

bool DhQDrag::event(QEvent* x1) {
  void* ro_ptr;
  void* rf_ptr;
...
bool DhQDrag::Dhevent(QEvent* x1) {
  return QObject::event(x1);
}

bool DhQDrag::Dvhevent(QEvent* x1) {
  return event(x1);
}

bool DhQDrag::eventFilter(QObject* x1, QEvent* x2) {
  void* ro_ptr;
  void* rf_ptr;
...
bool DhQDrag::DheventFilter(QObject* x1, QEvent* x2) {
  return QObject::eventFilter(x1, x2);
}

bool DhQDrag::DvheventFilter(QObject* x1, QEvent* x2) {
  return eventFilter(x1, x2);
}

int DhQDrag::receivers(const char* x1) const {
  void* ro_ptr;
  void* rf_ptr;
...
int DhQDrag::Dhreceivers(const char* x1) const {
  return QObject::receivers(x1);
}

int DhQDrag::Dvhreceivers(const char* x1) const {
  return receivers(x1);
}

QObject* DhQDrag::sender() const {
  void* ro_ptr;
  void* rf_ptr;
...
QObject* DhQDrag::Dhsender() const {
  return QObject::sender();
}

QObject* DhQDrag::Dvhsender() const {
  return sender();
}

void DhQDrag::timerEvent(QTimerEvent* x1) {
  void* ro_ptr;
  void* rf_ptr;
...
void DhQDrag::DhtimerEvent(QTimerEvent* x1) {
  return QObject::timerEvent(x1);
}

void DhQDrag::DvhtimerEvent(QTimerEvent* x1) {
  return timerEvent(x1);
}

QHash <QByteArray, int> DhQDrag::initXhHash() {
...
QHash <QByteArray, int> DhQDrag::xhHash = DhQDrag::initXhHash();

bool DhQDrag::setDynamicQHandler(void * ro_ptr, char * eventId, void * rf_ptr, void * st_ptr, void * df_ptr) {
...
bool DhQDrag::setDynamicQHandlerud(int udtyp, void * ro_ptr, int eventId, void * rf_ptr, void * st_ptr, void * df_ptr) {
  if ((udtyp < 0) || (udtyp > 2)) {
    return false;
  }
...
bool DhQDrag::unSetDynamicQHandler(char * eventId) {
  QByteArray theHandler = QMetaObject::normalizedSignature(eventId);
  if (xhHash.contains(theHandler)) {
    int thir = xhHash.value(theHandler);
...
bool DhQDrag::unSetDynamicQHandlerud(int udtyp, int eventId) {
  if ((udtyp < 0) || (udtyp > 2)) {
    return false;
  }
