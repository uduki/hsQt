function TetrixBoard(ui)
{
    ...
    connectDsSlot(this, "paintRequested(QPainter*)", this, "onPaint(QPainter*)", this.onPaint);
    connectDsSlot(this, "paintNextPieceRequested(QPainter*)", this, "onPaintNextPiece(QPainter*)", this.onPaintNextPiece);
    connectDsSlot(this, "keyPressEvent(int)", this, "keyPressEvent(int)", this.onKeyPress);
    connectDsCall(this, "drawSquare");
    connectDsCall(this, "showNextPiece");
    connectDsCall(this, "scoreChanged");
    connectDsCall(this, "linesRemovedChanged");
    connectDsCall(this, "levelChanged");
}
